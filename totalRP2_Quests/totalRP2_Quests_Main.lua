...
function TRP2_CreateQuestTabCreation()
	...
	Quest["bWriteLock"] = TRP2_CreationFrameQuestFrameFlagsWriteLock:GetChecked();
	Quest["bManual"] = TRP2_CreationFrameQuestFrameFlagsManual:GetChecked();
	Quest["bReinit"] = TRP2_CreationFrameQuestFrameFlagsReinit:GetChecked();
