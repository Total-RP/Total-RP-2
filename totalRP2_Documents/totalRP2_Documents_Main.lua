...
function TRP2_CreaDocuChargerImage(Elem,num)
	...
	TRP2_CreationFrameDocumentFrameImageDesaturated:SetChecked(TRP2_GetWithDefaut(tab,"Desaturated",false));
	TRP2_CreationFrameDocumentFrameImageRounded:SetChecked(TRP2_GetWithDefaut(tab,"bRound",false));
...
function TRP2_CreaDocuCreateTabString()
	...
	tab["bContours"] =TRP2_CreationFrameDocumentFrameStringContours:GetChecked();
...
function TRP2_CreaDocuCreateTabImage()
	...
	tab["Desaturated"] = TRP2_CreationFrameDocumentFrameImageDesaturated:GetChecked();
	tab["bRound"] = TRP2_CreationFrameDocumentFrameImageRounded:GetChecked();
...
function TRP2_CreateDocumentTabCreation()
	...
	Docu["bWriteLock"] = TRP2_CreationFrameDocumentFrameMenuWriteLock:GetChecked();
...
function TRP2_Set_Module_Document()
	...
	TRP2_DocumentFrameScrollTexte:SetFont("h1","Fonts\\"..TRP2_font, 25);
	TRP2_DocumentFrameScrollTexte:SetFont("h2","Fonts\\"..TRP2_font, 20);
	TRP2_DocumentFrameScrollTexte:SetFont("h3","Fonts\\"..TRP2_font, 13);
	TRP2_DocumentFrameScrollTexte:SetFont("Fonts\\"..TRP2_font,11);
...
function TRP2_ChargerDocument(infoTab,page,id,bApercu,bForce)
	...
	table.foreach(pageTab, function(image)
		if string.find(image,"Image%d+") then
			...
			texture:SetDesaturated(TRP2_GetWithDefaut(imageTab,"Desaturated",false));
...
function TRP2_EditPanneau(fonction)
	...
	TRP2_CreationPanneauFrameSave:SetScript("OnClick",function()
		panneauTab["bPublic"] = TRP2_CreationPanneauFramePublic:GetChecked();
