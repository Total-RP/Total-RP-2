...
function TRP2_EffetLifetimeLoad(temps,bRand, index)
	...
	TRP2_EffetLifetimeFrameSave:SetScript("OnClick", function()
		...
		local saisieTimeCheck;
		if TRP2_EffetLifetimeFrameSaisieTimeCheck:GetChecked() then
			saisieTimeCheck = 1;
		else
			saisieTimeCheck = 0;
		end

		TRP2_TriggerEditFrameEffet.effetTab[index] = "lifetime$"..tostring(TRP2_EffetLifetimeFrameSaisieTime:GetText()).."$"..tostring(saisieTimeCheck);
		TRP2_debug(TRP2_TriggerEditFrameEffet.effetTab[index]);
