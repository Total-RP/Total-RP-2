...
function TRP2_CreateAuraTabCreation()
	...
	objet["bWriteLock"] = TRP2_CreationFrameAuraFrameFlagsWriteLock:GetChecked();
	objet["bDeletable"] = TRP2_CreationFrameAuraFrameFlagsDeletable:GetChecked();
	objet["TimeSet"] = TRP2_CreationFrameAuraFrameFlagsTimeSet:GetChecked();
	objet["bAjout"] = TRP2_CreationFrameAuraFrameFlagsAjoutable:GetChecked();
