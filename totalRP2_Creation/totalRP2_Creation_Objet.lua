...
function TRP2_CreateObjetTabCreation()
	...
	objet["bWriteLock"] = TRP2_CreationFrameObjetFrameFlagsWriteLock:GetChecked();
	objet["bImmobile"] = TRP2_CreationFrameObjetFrameFlagsStealable:GetChecked();
	objet["bUtilisable"] = TRP2_CreationFrameObjetFrameFlagsUsable:GetChecked();
	objet["bGivable"] = TRP2_CreationFrameObjetFrameFlagsGivable:GetChecked();
	objet["bDestroyable"] = TRP2_CreationFrameObjetFrameFlagsDestroyable:GetChecked();
	objet["bManual"] = TRP2_CreationFrameObjetFrameFlagsManual:GetChecked();
	objet["bQuest"] = TRP2_CreationFrameObjetFrameFlagsQuest:GetChecked();
