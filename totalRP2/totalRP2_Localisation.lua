...
function TRP2_SetLocalisation(language)
    ...
    TRP2_LOC_NoTooltipColorTT = "Afficher la couleur personnalisée des personnages dans les infobulles";
	...
	elseif TRP2_GetConfigValueFor("Langue",2) == 5 then
		TRP2_LocalisationChinese();
		TRP2_LocalisationCreationChinese();
		TRP2_LocalisationBalisesChinese();
		TRP2_LocalisationBagsChinese();
		TRP2_LocalisationLanguagesChinese();
	end
...
function TRP2_LocalisationEnglish()
	...
	TRP2_LOC_MSPConcurrency = "{r}You can't have simultaneously more than one addon using the Mary Sue Protocol, {o}as they would be in conflict{r}.\nCurrently loaded :"
	...
	TRP2_LOC_StatutRP_TT = "Determines whether the character is currently played in character {v}(IC){o} or not {r}(OOC){o}.";
	...
	TRP2_LOC_RPTOHRP = "{j}Click{w}: Switch to {r}OOC status{w}";
...
function TRP2_LocalisationSpanish()
	...
	TRP2_LOC_AccessLevelDialog = "Nivel de confianza para los efectos de diálogo";
	TRP2_LOC_AccessLevelDialogTT = "Cuando se utiliza una creación que tiene efectos de diálogo (por ejemplo, mostrar una emoción, gritar...) y el nivel de confianza de la creación creador no coincide con este parámetro, entonces el efecto de diálogo se convierte en un efecto de texto local. Sólo tú lo verás.";
	TRP2_LOC_AccessLevelSound = "Nivel de confianza para los sonidos";
	TRP2_LOC_CONFIG_SECURITY = "Nivel de confianza y seguridad";
	TRP2_LOC_IMPORT_STATE_DEL = "{o}Eliminar el estado{v}[%1]{o} ?";
	TRP2_LOC_IMPORTED_STATE = "El estado ha sido importado.";
	TRP2_LOC_IMPORT_STATE = "{o}¿Te gustaría importar el estado{v}[%1]{o} ?";
	TRP2_LOC_IMPORTSTATETT = "Visualiza la lista con todos los estados que han subido otros personajes y te permite importar el tema en tu lista de estados.";
	TRP2_LOC_IMPORTSTATE = "Importar estado";
	TRP2_LOC_DOWUWARNELEM = "{v}¡No olvides guardar el elemento editado antes de editar otro!";
	TRP2_LOC_DOWUWARNPAGE = "{v}¡No olvides guardar la página actual antes de abrir otra para editar!";
	TRP2_LOC_CLASS_TT = "Esta es la clase personalizada del personaje.\n\n{v}Por ejemplo :\n{o}Caballero, Piromante, Nigromante, Tirador de élite, Arcanista ...";
	TRP2_LOC_PAR_UseBroadcast_TT = "El canal de difusión del TRP2 permite utilizar funciones como la reproducción de sonidos locales o la búsqueda de escondites/carteles/casas...\n\n{r}Si decides desactivar esta opción, se necesita un reinicio con el fin de activarlo.";
	TRP2_LOC_PAR_UseBroadcast = "Utilicar el canal de difusión";
	TRP2_LOC_PAR_TipsCheck = "Mostrar consejos";
	TRP2_LOC_PAR_TipsCheck_TT = "Mostrar cuadro de diálogo con matices.\n\nCada consejo puede ocultarse definitivamente pulsando \"No mostrar\" cuando se muestran.";
	TRP2_LOC_DOCWARNING = "{o}Observación sobre la creación del documento: \n \n {v} ¡No olvides guardar todos los \"nivel \" del documento! \n\n {o} Por ejemplo, si se modifica una imagen, tendrás que guardar esta imagen, despues la página y, finalmente, todo el documento.";
	TRP2_LOC_PAR_ShowActuhrp = "Mostrar información FdR";
	TRP2_LOC_HRPINFO = "Otra información (FdR)";
	TRP2_LOC_HRPINFO_TT = "Pon aquí la información FdR actual importante de tu personaje.\n\n¡Por favor, ser conciso, no olvides que esta información se mostrará en la descripción de tu personaje!\n\nConsejo: la longitud de esta información NO debería ser superior a 3-4 líneas ...";
	TRP2_LOC_RANDOM_TT = "Si es aleatorio, se elegirá el número aleatorio entre 1  y el número introducido en el cuadro izquierdo.";
	TRP2_LOC_RANDOM = "Selección aleatoria";
	TRP2_LOC_AKNOWLEDGEPACK = "{o}%1{v} acabas de recibir un paquete : {o}%2{v} las creaciones han sido importadas o actualizadas.";
	TRP2_LOC_PACKAGESENDINFO1 = "Puedes cerrar esta caja, el paquete todavía se descargará. Se notificará cuando se haya completado la descarga.";
	TRP2_LOC_PACKAGESIZE = "Tamaño del paquete";
	TRP2_LOC_RECEIVFROM = "Recibido de {v}%1";
	TRP2_LOC_PACKAGEDONE = "{v}Acabas de recibir un paquete de {o}%1{v} : {o}%2{v} la creacion ha sido importad ao actualizada.";
	TRP2_LOC_PACKDOWNLOAD = "Descargando\npaquete";
	TRP2_LOC_PACKASK = "{v}Intercambio de paquete\n\n{j}%6{o} quieres que le enviemos el paquete :\n{v}%1.\n\nNúmero de creaciones : {o}%2\n{w}Tamaño total del paquete : {o}%3{w}\n({o}%4 {w}mensaje(s))\n\nRecibir este paquete tardará :\n{o}%5{w}\n(estimado en condiciones optimas)\n\n¿Comenzar la trasferencia?";
	TRP2_LOC_ALREADYALLPACK = "{v}%1 {o}ya tienes la versión más reciente de todas las creaciones de los paquetes.";
	TRP2_LOC_SendPackage = "Enviar paquete";
	TRP2_LOC_PACKSTATS = "{w}Información del paquete {o}%1\n\Número de creaciones : {o}%2\n{w}Tamaño total del paquete : {o}%3{w}\n({o}%4 {w}mensaje(s))\n\nEnviar este paquete tardará :\n{o}%5{w}\n(estimado en condiciones optimas)";
	TRP2_LOC_ADDCHAINPACK = "¿Te gustaría añadir también al paquete todas las creaciones vinculadas a éste?";
	TRP2_LOC_PackageWarning1  ="{r}Esta creación es desconocida, ya no tiene información. No se intercambian con el paquete.\nEs aconsejable retirarlo del paquete.\n";
	TRP2_LOC_DELETEPACK = "Eliminar paquete";
	TRP2_LOC_OPENPACK = "Abrir paquete";
	TRP2_LOC_HABITATS = "Residencias";
	TRP2_LOC_CREATEPACKAGE = "{v}Creación de paquete\n\n{o}Por favor, escribe el nombre del paquete.";
	TRP2_LOC_DOMICILETEXT = "{v}Creación de residencia\n\n{o}Por favor, ingresa el nombre de la residencia. "
		.."No añadas el nombre del personaje en esta nota, porque aparecerá de todos modos al final.{j}\n\nPor favor, ten en cuenta que un personaje sólo puede tener una residencia a la vez."
		.." Esta residencia sustituirá a la anterior (si existir).{o}\n\nTambién ten en cuenta que esta característica es público. ¡Si no quieres que la gente sepa donde vive tu personaje, entonces no utilice esta característica!";
	TRP2_LOC_NEWPACKAGE = "Nuevo paquete";
	TRP2_LOC_PACKAGES = "Paquetes";
	TRP2_LOC_DEL_REF_PACK = "{w}¿Borrar este paquete: {v}%1{w}?";
	TRP2_LOC_PACKAGE = "Paquete";
	TRP2_LOC_NoPACKAGES = "Sin\npaquete";
	TRP2_LOC_HOUSENAME = "Nombre de la residencia";
	TRP2_LOC_HOUSEDONE = "{v}%1 has establecido tu residencia aquí : %2 ! (%3)";
	TRP2_LOC_CANHOUSEHERE = "No puedes establecer tu residencia aquí.";
	TRP2_LOC_HABITAT_MAP_ACTION = "Establecer tu residencia aquí";
	TRP2_LOC_HABITAT_MAPTT = "Ver residencias";
	TRP2_LOC_TRP2FUNCT = "Caracteristicas del TRP2";
	TRP2_LOC_ESTIMATIONTT = "Esta estimación es el {r}mínimo{j} tiempo necesario para la descarga del documento (estimado en condiciones oprimas).";
	TRP2_LOC_ESTIMATIONTRANSF = "Tiempo estimado para la trasferencia";
	TRP2_LOC_Downloading = "Descargando";
	TRP2_LOC_RecherchePanneau = "Búsqueda de carteles";
	TRP2_LOC_DELETEPANNEAU = "Retirar cartel";
	TRP2_LOC_NOPANNEAU = "Sin\ncartel";
	TRP2_LOC_NOPANNEAUHERE = "No se han\nhallado\ncarteles";
	TRP2_LOC_READDOCU = "Mostrar documento";
	TRP2_LOC_PASENCORELU = "No leído todavía";
	TRP2_LOC_HAVETOUPDATEDOCU = "No tienes la última versión del documento. Será necesaria descargarla para mostrarlo.";
	TRP2_LOC_HAVETODOWNLOADDOCU = "No tienes la información del documento. será necesaria descargarla para mostrarlo.";
	TRP2_LOC_PANNEAUPUBLIC = "Cartel público";
	TRP2_LOC_MODIFPANNEAU = "Editar cartel";
	TRP2_LOC_MESSNUM = "Número del mensaje";
	TRP2_LOC_DOCUMENTSIZE = "Tamaño del documento";
	TRP2_LOC_CANTPANNEAUHERE = "No puedes colocar un cartel aquí.";
	TRP2_LOC_ALREADY_PANNEAU = "Ya hay un cartel colocado aquí.";
	TRP2_LOC_NEWPANNEAU = "Nuevo cartel";
	TRP2_LOC_CREATE_PANNEAU = "El cartel %1 se ha colocado.";
	TRP2_LOC_MODIF_PANNEAU = "El cartel %1 se ha editado.";
	TRP2_LOC_DELETE_PANNEAU = "El cartel %1 se ha eliminado.";
	TRP2_LOC_DELPANNEAUTT = "¿Eliminar este cartel?";
	TRP2_LOC_SEARCHPANNEAU = "Buscár un cartel en los alrededores";
	TRP2_LOC_ListeVosPanneau = "Lista de señales";
	TRP2_LOC_OPENPANNEAU = "Texto de su cartel aquí";
	TRP2_LOC_CREATEPANNEAU = "Colocar una nueva seña aquí";
	TRP2_LOC_COORDGEST = "Escondrijos y carteles";
	TRP2_LOC_PLANQUES = "Esondrijos";
	TRP2_LOC_PANNEAUX = "Carteles";
	TRP2_LOC_PANNEAUX_TT = "Mostrar carteles.";
	TRP2_LOC_PANNEAUX_TTown = "Mostrar tus carteles.";
	TRP2_LOC_PANNEAUX_TTothers = "Mostrar otros carteles públicos.";
	TRP2_LOC_SHOWMENU = "Visializár menú";
	TRP2_LOC_PANNEAUXMANAGE = "Gestionar carteles";
	TRP2_LOC_PLANQUESMANAGE = "Gestionar escondrijos";
	TRP2_LOC_CREATIONPANNEAU = "Crear un nuevo cartel";
	TRP2_LOC_NOMPANNEAU_TT = "Nombre del cartel.\nNo tiene porque ser  el mismo nombre que el del personaje.";
	TRP2_LOC_PANNEAUPUBLIC_TT = "Tu cartel es público, se mostrará en el buscadór de carteles. Utiliza las condiciones de acceso (caracteres autorizados y el nivel de confianza) incluso para carteles públicos.";
	TRP2_LOC_PanneauPerm_TT = "Esta es una lista de las personas que tendrán acceso al cartel.\nPor favor, introcude los nombres separados por comas.\n\n{j}Si dejas esta csilla vacía, nadie será capaz de leer el cartel, siempre y cuando coincida con el nivel de confianza especificado a continuación.";
	TRP2_LOC_PanneauAcces_TT = "Este es el nivel de confianza mínima necesaria para acceder a este cartel.\n\n{j}Ten en cuenta que funciona por encima del caracter añadido.";
	TRP2_LOC_PANNEAU = "Cartel";
	TRP2_LOC_PANNEAUTWO = "Cartel";
	TRP2_LOC_PLANQUEPUBLICTT = "Tu escondrijo es público, se mostrará en el bucador de escondrijos.Utiliza las condiciones de acceso (caracteres autorizados y el nivel de confianza) incluso para escondrijos públicos.";
	TRP2_LOC_PLANQUEPUBLIC = "Escondrijo público";
	TRP2_LOC_SHOWYOURPLAQNUE = "Mostrar escondrijos";
	TRP2_LOC_SHOWOTHERPLAQNUE = "Mostrar otros escondrijos públicos";
	-- Version 1012
	...
	TRP2_LOC_PlanqueAcces_TT = "Este es el nivel de confianza mínimo necesario para acceder a este escondrijo.\n\n{j}Tenga en cuenta que funciona por encima del caracter añadido.";
	TRP2_LOC_PLANQUEINTER = "No pueden acceder dos persona al mismo escondrijo a la vez.\n\n{v}%1{w} ya esta accediendo a este escondrijo. ¿Deseas expulsarlo para poder abrirlo?";
...
function TRP2_LocalisationGerman()
	...
	TRP2_LOC_StatutRP = "RP-Status";
	TRP2_LOC_StatutRP_TT = "Bestimmt ob der Charakter im Moment {v}(IC){o} oder {r}(OOC){o} ist.";
	...
	TRP2_LOC_RPTOHRP = "{j}Klick{w}: Wechseln zu {r}OOC status{w}";
...
function TRP2_LocalisationChinese()

      TRP2_LOC_TitreTT = "Display player's titles in the chat frame.";
    TRP2_LOC_NoColorTT = "Display custom colors for name in the chat frame.";
    TRP2_LOC_NoTooltipColorTT = "Display custom colors in the tooltip";
	
	TRP2_LOC_PURGELANG = "忘却";
	TRP2_LOC_PURGELANGTT = "重置已知语言";
	TRP2_LOC_PAR_UsePlayerIcon = "使用角色图标";
	TRP2_LOC_PAR_UsePlayerIconTT = "改变角色在目标栏中的样子";
	TRP2_LOC_EXPORTPAKINPAK = "将内容加入导出包";
	TRP2_LOC_AccessLevelScript = "LUA脚本信任值";
	TRP2_LOC_AccessLevelScriptTT = "自定义内容作者可将LUA脚本定位标记于物品、状态、和任务上。这些脚本可以令创造的可能性翻倍，但也能被恶意利用...比方说，恶意用户可以制作出能清空一切存储变量的脚本。\n\n{r}不管怎么说，建议只有在你完全信任其作者时，才开启原创物品附带的脚本。\n\n{r}变动此选项如有任何风险请自行承担!!!";
	TRP2_LOC_AccessLevelDialog = "对话效果信任值";
	TRP2_LOC_AccessLevelDialogTT = "当你使用一件带有对话效果(say, emote, yell)的原创物品时，如果其作者的信任度不符合此参量，那么对话效果便会转换为本地文字。只有你会看到它。";
	TRP2_LOC_AccessLevelSound = "音效信任值";
	TRP2_LOC_CONFIG_SECURITY = "信任值与安全";
	TRP2_LOC_IMPORT_STATE_DEL = "{o}删除状态 {v}[%1]{o} ?";
	TRP2_LOC_IMPORTED_STATE = "状态已导入。";
	TRP2_LOC_IMPORT_STATE = "{o}是否导入状态 {v}[%1]{o} ?";
	TRP2_LOC_IMPORTSTATETT = "显示从其他人物身上获得的状态列表，并允许你将其导入你自己的状态列表中。";
	TRP2_LOC_IMPORTSTATE = "导入状态";
	TRP2_LOC_DOWUWARNELEM = "{v}请勿忘记，先保存好目前的要素再去编辑下一个!";
	TRP2_LOC_DOWUWARNPAGE = "{v}请勿忘记，先保存好目前的页面再去打开下一页!";
	TRP2_LOC_CLASS_TT = "这是你的人物的自定义职业。\n\n{v}比如说:\n{o}骑士，烟火师，通灵巫师，精英射手，奥术师 ...";
	TRP2_LOC_PAR_UseBroadcast_TT = "广播频道使TRP2能够使用某些功能，比如说播放本地声音、搜寻其他玩家的窝点/组织/房屋...等。\n\n{r}如果你决定关闭此选项，变动重新联网后才会生效。";
	TRP2_LOC_PAR_UseBroadcast = "使用广播频道";
	TRP2_LOC_PAR_TipsCheck = "显示提示";
	TRP2_LOC_PAR_TipsCheck_TT = "在对话框中显示提示。\n\n在提示出现时，每个提示可通过点击 \"Do not show\" 单独关闭。";
	TRP2_LOC_DOCWARNING = "{o}自定义文件的评论 :\n\n{v}请记得要一层一层保存文档!\n\n{o}比如说，如果你改动了一张图片，你需要保存这个图片，然后再保存该页面，最终保存整个文档。";
	TRP2_LOC_PAR_ShowActuhrp = "显示OOC信息";
	TRP2_LOC_HRPINFO = "其他信息(OOC)";
	TRP2_LOC_HRPINFO_TT = "将人物目前的重要OOC信息填写在这里。\n\n请尽量简洁；不要忘了，这些信息会显示在你人物的信息框里!\n\n提示：信息长度请切勿超过3-4行...";
	TRP2_LOC_RANDOM_TT = "如果随机，将随进在1与左边窗框中输入的数字之间选择一个数字。";
	TRP2_LOC_RANDOM = "随机";
	TRP2_LOC_AKNOWLEDGEPACK = "{o}%1{v} 刚刚收到了你的包裹 : {o}%2{v} 自定义内容已被导入或更新。";
	TRP2_LOC_PACKAGESENDINFO1 = "你可以关闭此窗口，包裹将继续在背景中下载。下载结束时，会有通知。";
	TRP2_LOC_PACKAGESIZE = "包裹大小";
	TRP2_LOC_RECEIVFROM = "正从 {v}%1 接收";
	TRP2_LOC_PACKAGEDONE = "{v}你刚从 {o}%1{v} 收到了包裹 : {o}%2{v} 自定义内容已被导入或更新。";
	TRP2_LOC_PACKDOWNLOAD = "下载\n包裹";
	TRP2_LOC_PACKASK = "{v}交换包裹\n\n{j}%6{o} 想发送给你包裹 :\n{v}%1.\n\n自定义内容数量 : {o}%2\n{w}包裹总大小 : {o}%3{w}\n({o}%4 {w}条信息)\n\n接收此包裹需要 :\n{o}%5{w}\n(最理想情况下估算)\n\n开始传输?";
	TRP2_LOC_ALREADYALLPACK = "{v}%1 {o}已经有你包裹中自定义内容的最新版本了。";
	TRP2_LOC_SendPackage = "发送包裹";
	TRP2_LOC_PACKSTATS = "{w}包裹信息 {o}%1\n\n自定义内容数量 : {o}%2\n{w}包裹总大小 : {o}%3{w}\n({o}%4 {w}条信息)\n\n发送此包裹需要 :\n{o}%5{w}\n(最理想情况下估算)";
	TRP2_LOC_ADDCHAINPACK = "是否将所有已关联自定义内容加入包裹 ?";
	TRP2_LOC_PackageWarning1  ="{r}这是未知内容，因为你没有其信息。它将不会跟随包裹传送。\n建议将它从包裹中移除。\n";
	TRP2_LOC_DELETEPACK = "删除包裹";
	TRP2_LOC_OPENPACK = "打开包裹";
	TRP2_LOC_HABITATS = "住处";
	TRP2_LOC_CREATEPACKAGE = "{v}包裹生成\n\n{o}请输入包裹名字。";
	TRP2_LOC_DOMICILETEXT = "{v}设定住处\n\n{o}请输入此住处的简短注释。"
		.."请不要在注释中输入人物的名字，因为名字会在末尾处显示。{j}\n\n请注意，一个人物同时只能有一个住处。"
		.." 此住处将替代老住处 (如果存在的话)。{o}\n\n另外，这个功能就像是公共宣告。如果你不希望别人知道你的人物住在哪里，那么就不要使用这个功能!";
	TRP2_LOC_NEWPACKAGE = "新包裹";
	TRP2_LOC_PACKAGES = "自定义内容包";
	TRP2_LOC_DEL_REF_PACK = "{w}删除此包裹 : {v}%1{w} ?";
	TRP2_LOC_PACKAGE = "自定义内容包";
	TRP2_LOC_NoPACKAGES = "无\n包裹";
	TRP2_LOC_HOUSENAME = "住处名";
	TRP2_LOC_HOUSEDONE = "{v}%1 在 %2 住下了! (%3)";
	TRP2_LOC_CANHOUSEHERE = "你不能住在这里";
	TRP2_LOC_HABITAT_MAP_ACTION = "在这里住下";
	TRP2_LOC_HABITAT_MAPTT = "显示住处";
	TRP2_LOC_TRP2FUNCT = "TRP2 功能";
	TRP2_LOC_ESTIMATIONTT = "此估算为文件下载{r}最小{j}时间(最理想情况下估算).";
	TRP2_LOC_ESTIMATIONTRANSF = "大概传送时间";
	TRP2_LOC_Downloading = "下载中";
	TRP2_LOC_RecherchePanneau = "搜索路牌中";
	TRP2_LOC_DELETEPANNEAU = "移除路牌";
	TRP2_LOC_NOPANNEAU = "无\n路牌";
	TRP2_LOC_NOPANNEAUHERE = "无\n路牌\n被找到";
	TRP2_LOC_READDOCU = "显示文件";
	TRP2_LOC_PASENCORELU = "未读";
	TRP2_LOC_HAVETOUPDATEDOCU = "你没有此文件的最新版本。下载后才能显示。";
	TRP2_LOC_HAVETODOWNLOADDOCU = "你没有此文件的信息。下载后才能显示。";
	TRP2_LOC_PANNEAUPUBLIC = "公共路牌";
	TRP2_LOC_MODIFPANNEAU = "编辑路牌";
	TRP2_LOC_MESSNUM = "信息数量";
	TRP2_LOC_DOCUMENTSIZE = "文件大小";
	TRP2_LOC_CANTPANNEAUHERE = "你不能在这里放置路牌。";
	TRP2_LOC_ALREADY_PANNEAU = "你已有路牌放在这里。";
	TRP2_LOC_NEWPANNEAU = "新路牌";
	TRP2_LOC_CREATE_PANNEAU = "路牌%1已被放置.";
	TRP2_LOC_MODIF_PANNEAU = "路牌%1已被编辑。";
	TRP2_LOC_DELETE_PANNEAU = "路牌%1已被移除。";
	TRP2_LOC_DELPANNEAUTT = "移除此路牌 ?";
	TRP2_LOC_SEARCHPANNEAU = "在附近搜索路牌";
	TRP2_LOC_ListeVosPanneau = "管理路牌";
	TRP2_LOC_OPENPANNEAU = "在此处阅读路牌";
	TRP2_LOC_CREATEPANNEAU = "在此处放置新的路牌";
	TRP2_LOC_COORDGEST = "储藏地和路牌";
	TRP2_LOC_PLANQUES = "储藏地";
	TRP2_LOC_PANNEAUX = "路牌";
	TRP2_LOC_PANNEAUX_TT = "显示此地区的路牌。";
	TRP2_LOC_PANNEAUX_TTown = "显示你的路牌。";
	TRP2_LOC_PANNEAUX_TTothers = "显示其他人的路牌。";
	TRP2_LOC_SHOWMENU = "显示菜单";
	TRP2_LOC_PANNEAUXMANAGE = "路牌管理";
	TRP2_LOC_PLANQUESMANAGE = "储藏地管理";
	TRP2_LOC_CREATIONPANNEAU = "创建新的路牌";
	TRP2_LOC_NOMPANNEAU_TT = "你的路牌的名称。\n它并不一定与相关联的文件同名。";
	TRP2_LOC_PANNEAUPUBLIC_TT = "一个公共路牌会在地图上搜索路牌中显示。使用条件(授权人物和信任值)在公共路牌上同样生效。";
	TRP2_LOC_PanneauPerm_TT = "这是拥有使用你的路牌的受权的人物列表。\n请输入人物名称，以英文逗号(,)分隔。\n\n{j}如果你保留此处空白，任何人只要达到了你所设定的信任值，便可阅读你的路牌。";
	TRP2_LOC_PanneauAcces_TT = "这是使用此路牌所需的最低信任值。\n\n{j}这将与上方的人物列表同时生效。";
	TRP2_LOC_PANNEAU = "路牌";
	TRP2_LOC_PANNEAUTWO = "路牌";
	TRP2_LOC_PLANQUEPUBLICTT = "一个公共储藏地会在地图上搜索路牌中显示。使用条件(授权人物和信任值)在公共储藏地上同样生效。";
	TRP2_LOC_PLANQUEPUBLIC = "公共储藏地";
	TRP2_LOC_SHOWYOURPLAQNUE = "显示所有储藏地";
	TRP2_LOC_SHOWOTHERPLAQNUE = "显示他人的储藏地";
	-- Version 1012
	TRP2_LOC_SHOWCLIENT = "显示客户端";
	TRP2_LOC_EFFETHASSCRIPT = "{v}此时间带有自定义脚本。";
	TRP2_LOC_EFFETNOSCRIPT = "{j}该事件无自定义脚本。";
	TRP2_LOC_EFFETSCRIPT = "自定义脚本";
	TRP2_LOC_EFFETSCRIPTTT = "变动效果的自定义Lua脚本.\n\n{o}此功能保留于知道如何正确使用Lua编程语言的用户使用!";
	TRP2_LOC_MSPConcurrency = "{r}你无法同时使用一个以上使用Mary Sue Protocol(玛丽苏协议)这个程序的插件，{o}因为它们会发生冲突{r}.\n目前已加载 :"
								.."\n\n{v}Total RP 2 {r}和 {v}%1{r}.\n\n{o}Total RP 2 目前支持 MSP，并可以兼容 (\"也就是可以交流\") 其他的MSP插件 (MyRoleplay, FlagRSP 2.5 ...etc).{r}\n\nTotal RP 2 的 MSP功能会被禁用。";
	TRP2_LOC_LoadingItem = "正在接收物品数据...";
	TRP2_LOC_ITEMLINKDISCLAMER = "Total RP 2 物品";
	TRP2_LOC_MSP_RS = {"OOC","IC"};
	TRP2_LOC_BLOCKEDSCRIPTS = "脚本被拦截";
	-- Version 1002
	TRP2_LOC_AnchorTab = {
		"左上","上","右上","右","右下","下","左下","下"
	};
	TRP2_LOC_PAR_AnchorPointTT2 = "指定人物鼠标提示框的定位点。";
	TRP2_LOC_PAR_AnchorPointTT1 = "指定坐骑鼠标提示框的定位点。";
	TRP2_LOC_PAR_AnchorPoint = "定位点";
	TRP2_LOC_PAR_AnchorTT = "鼠标提示框定位点";
	TRP2_LOC_PAR_AnchorTT_TT1 = "设定人物鼠标提示框定位于哪个系统窗口。\n\n默认 : {j}GameTooltip{o}\n\n如输入的窗口不存在, 将会显示红色文字 {r}(Outch!)";
	TRP2_LOC_PAR_AnchorTT_TT2 = "设定坐骑鼠标提示框定位于哪个系统窗口。\n\n默认 : {j}TRP2_PersoTooltip{o}\n\n如输入的窗口不存在, 将会显示红色文字 {r}(Outch!)";
	TRP2_LOC_DELETEALL = "全部清除";
	TRP2_LOC_TRPCommands = "Total RP 2 指令";
	TRP2_LOC_TRPCommands1 = "{j}/trp2 {o}指令{j}参量";
	TRP2_LOC_TRPCommandsRP = "切换RP状态(IC/OOC)";
	TRP2_LOC_TRPCommandsGuide = "显示使用手册";
	TRP2_LOC_TRPCommandsGuideError1 = "TRP2_Guide_Zh 模块没有开启";
	TRP2_LOC_TRPCommandsDice = "投骰子";
	TRP2_LOC_TRPCommandsOR = "或";
	TRP2_LOC_TRPCommandsRPStat = "RP状态";
	TRP2_LOC_TRPCommandsGuidebook = "使用手册";
	TRP2_LOC_TRPCommandsShow = "显示";
	TRP2_LOC_TRPCommandsShowTT = "显示/隐藏主窗口";
	TRP2_LOC_TRPCommandsShowRacc = "快捷方式";
	TRP2_LOC_TRPCommandsShowRaccTT = "显示/隐藏快捷方式条";
	TRP2_LOC_TRPCommandsShowCreaList = "自定义内容";
	TRP2_LOC_TRPCommandsShowCreaListTT = "显示自定义内容列表";
	TRP2_LOC_PAR_MapToUse = "地图窗口";
	TRP2_LOC_PAR_MapToUseTT = "决定世界地图窗口。";
	TRP2_LOC_PAR_GuildIC = "OOC公会频道";
	TRP2_LOC_PAR_GuildICTT = "如果你的公会频道不是IC的话，请开启此栏。TRP2不会再OOC公会频道中探测到e/和OOC语句，不会使用自定义方言。";
	TRP2_LOC_PAR_UseCoordTT = "禁用坐标系统 : 储藏地，本地音效，在地图上探测其他TRP2用户..."
									.."\n\n{j}如发现与其他使用地图系统的插件有冲突，请禁用这个选项。"
									.."\n\n{r}变动在重启游戏或重载界面后才会生效。(/reload).";
	TRP2_LOC_PAR_UseCoord = "禁用坐标系统";
	TRP2_LOC_INSERTBAL = "插入TAG";
	TRP2_LOC_UI_BalTexteMP = "布局TAG";
	TRP2_LOC_AUDIBLE = "非静音";
	TRP2_PETDIET = "宠物饮食";
	TRP2_LOC_RECUPTT = "获取此人物的全部状态。";
	TRP2_LOC_RECUP = "获取状态";
    TRP2_LOC_PAR_ActivateExchange = "启动数据传输";
    TRP2_LOC_PAR_ActivateExchangeTT = "屏蔽与其他用户的信息交流。\n\n{v}可以用来在制作和测试状态时，禁止公开播放它们。";
    TRP2_LOC_DeBanirCrea = "{o}自定义内容{v}[%1]{o}禁用已解除。";
    TRP2_LOC_BanirCrea = "{r}自定义内容{v}[%1]{r}已被禁用。";
    TRP2_LOC_CLICDROITALT = "Alt+右键";
    TRP2_LOC_BANID = "禁用此自定义内容";
    TRP2_LOC_NomDeFamille = "姓氏";
    TRP2_LOC_NomDeFamilleTT = "在聊天窗口中显示人物姓氏。";
    TRP2_LOC_EPURETATPre = "清空状态列表";
    TRP2_LOC_EPURETATTT = "删除已禁用状态的全部信息。";
    TRP2_LOC_EPURETAT = "删除全部被禁用的状态?";
    TRP2_LOC_EPURETAT2 = "{j}清空状态列表: %1个状态被删除。";
    TRP2_LOC_EPURETAT3 = "没有可删除的状态";
    TRP2_LOC_RACCBAR1 = "已使用的位置";
    TRP2_LOC_RACCBAR2 = "储藏地正被使用";
    TRP2_LOC_RACCBAR3 = "{r}关闭{w} TRP2 声音";
    TRP2_LOC_RACCBAR4 = "{v}E开启{w} TRP2 声音";
    TRP2_LOC_ItemToSell = "待售物品";
    TRP2_LOC_MagVide = "这家店\n是空的";
    TRP2_LOC_MagClose = "休息中!";
    TRP2_LOC_MagCloseMessage = "此店铺营业时间为%1h至%2h。其余时间，价格将高出25% ，因为你要先叫醒店主!";
    TRP2_LOC_ETATSMAG = "店主状态";
    TRP2_LOC_MAG_BoutikShow = "显示此地区的店铺";
    TRP2_LOC_PAR_EtatAcces = "自定义状态信任值";
    TRP2_LOC_PAR_EtatAccesTT = "设置获取其他用户的自定义状态所需的信任值。";
    TRP2_LOC_Animate = "动画";
	TRP2_LOC_ACCUEIL = "{v}Total RP 2 Build {o}"..TRP2_version.."\n{c}感谢使用Total RP 2!提狗改装版 代码：尼尔 纠错&汉化：拉个丝 感谢原汉化：老芹菜前辈奠定的基础。祝游戏愉快!\nCheck out Total RP 3, available in beta test on Curse http://www.curse.com/addons/wow/total-rp-3\n";
	TRP2_LOC_GPS = "{j}"..LOCATION_COLON.."\n"..CONTINENT.." : %1\n"..ZONE_COLON.." %2\nSubzone: %3\nX: %4  , Y: %5";
	TRP2_LOC_PAR_ChatFrameExplication = "聊天窗口: \n1 - 综合\n2 - 战斗\n3 à 7 - 其余";
	TRP2_LOC_ToolTips = "鼠标提示框";
	TRP2_LOC_ToolTipPerso = "人物鼠标提示框";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- FICHE PERSONNAGE
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_TRUSTNEEDED = "你未达到查看此人物故事的信任值。";
	TRP2_LOC_REALM = "服务器";
	TRP2_LOC_FICHE = "{v}%1的人物卡";
	TRP2_LOC_FICHEPERSO = "人物卡";
	TRP2_LOC_LANGPERSO = "人物的方言";
	TRP2_LOC_PETSPERSO = "小伙伴";
	TRP2_LOC_REGISTRE = "通讯薄";
	TRP2_LOC_Relation = "关系";
	TRP2_LOC_RelationTab = {};
	TRP2_LOC_RelationTab[1] = "敌意";
	TRP2_LOC_RelationTab[2] = "无";
	TRP2_LOC_RelationTab[3] = "中立";
	TRP2_LOC_RelationTab[4] = "商务";
	TRP2_LOC_RelationTab[5] = "友善";
	TRP2_LOC_RelationTab[6] = "亲密";
	TRP2_LOC_RelationTab[7] = "家人";
	TRP2_LOC_RelationTab[8] = "全部";
	TRP2_LOC_AccessTab = {};
	TRP2_LOC_AccessTab[1] = "忽视";
	TRP2_LOC_AccessTab[2] = "最小";
	TRP2_LOC_AccessTab[3] = "正常";
	TRP2_LOC_AccessTab[4] = "最大";
	TRP2_LOC_AccessTab[5] = ALL;
	TRP2_LOC_General = "通讯薄信息";
	TRP2_LOC_Physique = "人物描述";
	TRP2_LOC_Description = "描述";
	TRP2_LOC_Psycho = "性格";
	TRP2_LOC_Psycho2 = "性格指标";
	TRP2_LOC_Caracteristiques = "状态";
	TRP2_LOC_Histoire = "背景";
	TRP2_LOC_Histoire_TT = "你可以在这里概括你的人物一生中重要的背景要素。{v}请记得，这是个简短的概要{o}, 用来吸引他人与你的人物互动的兴趣。完整的背景故事可以放在论坛上，或者分开放在概要的后面。";
	TRP2_LOC_Auras = "状态";
	TRP2_LOC_DeleteRegAll = "{r}小心!\n\n{w}你正要删除所有在 "..TRP2_Royaume.." 人物上收集的信息。\n信任值不会被删除\n\n是否继续?";
	TRP2_LOC_Histoire2 = "人物背景";
	TRP2_LOC_Actu = "当前";
	TRP2_LOC_Actu3 = "当前信息";
	TRP2_LOC_ActuTT = "{o}在这里输入人物{v}目前{o}的{v}重要{o}信息。\n这将是其他玩家所看到的第一条信息。请尽量简短，别忘了这些信息将显示在人物的鼠标提示框中!";
	TRP2_LOC_EpurerRegVide = "你的通讯薄中没有任何未在"..TRP2_Royaume.."遇见的人物。";
	TRP2_LOC_EpurerRegCount = "你的通讯录中有 %1 个从未遇见过的人物。\n\n是否删除他们的信息?";
	TRP2_LOC_Actu2 = "当前具体信息";
	TRP2_LOC_PersoIgnroe = "忽视的人物";
	TRP2_LOC_NOTITRE = "< 无称号 >";
	TRP2_LOC_Consulte = "浏览";
	TRP2_LOC_Consulte_TT = "返回浏览模式。";
	TRP2_LOC_MenuJoueur = "人物菜单";
	TRP2_LOC_MenuRegistre = "通讯薄菜单";
	TRP2_LOC_Edition = "编辑";
	TRP2_LOC_Edition_TT = "编辑此版面上的属性。";
	TRP2_LOC_Save = "保存";
	TRP2_LOC_Save_TT = "{v}保存{o}此版面上的更改，并返回浏览模式。";
	TRP2_LOC_StatutRP = "RP状态";
	TRP2_LOC_StatutRP_TT = "决定此人物当前是否在扮演人物中 {v}(IC){o} 或 {r}(OOC){o}。";
	TRP2_LOC_StatutHRP = "OOC";
	TRP2_LOC_StatutXP = "RP经验标记";
	TRP2_LOC_StatutXP_TT = "{v}新手:\n{o}此标记会显示在人物的鼠标提示框的右上方，表明此玩家缺少RP经验，希望得到其他玩家的引导和帮助。\n\n{v}志愿者:\n{o}此标记会显示在人物的鼠标提示框的右上方，"
								.." 说明此玩家愿意帮助新手，解答一些关于基本RP方法，世界历史等问题。";
	TRP2_LOC_StatutRP_Tab = {};
	TRP2_LOC_StatutRP_Tab[1] = "{r}(OOC)";
	TRP2_LOC_StatutRP_Tab[2] = "{v}(IC)";
	TRP2_LOC_StatutXP_Tab = {};
	TRP2_LOC_StatutXP_Tab[1] = "{o}新手";
	TRP2_LOC_StatutXP_Tab[2] = "{w}无标记";
	TRP2_LOC_StatutXP_Tab[3] = "{v}志愿者";
	TRP2_LOC_INBOX = "收件箱";
	TRP2_LOC_OUTBOX = "发件箱";
	TRP2_LOC_COURRATT = "队列中的信件";
	TRP2_LOC_NOCOURR = "无\n信件";
	TRP2_LOC_Chaotique = "混乱";
	TRP2_LOC_Chaotique_TT = "{c}\"混乱\"{o}是自由的同义词, 有着无限的适应能力和灵活性; 其缺点则是鲁莽, 不可靠, 对权威的不满和独断独行的习性。";
	TRP2_LOC_Loyal = "守法";
	TRP2_LOC_Loyal_TT = "{c}\"法律\"{o} 有着很大的意义，比如说荣誉，信任，顺从权威，和可靠性。缺点则可能是视角狭窄，保守主义，偏见，和缺乏适应能力。";
	TRP2_LOC_Chaste = "贞洁";
	TRP2_LOC_Chaste_TT = "贞洁的人会回避一切肉体上的快感，即使是独身一人。\n他们思想纯洁，举止无暇。\n{c}\"忠于婚姻\" {o}也许是他们的格言。\n一个简单的吻也许就已经超过了他们的接受能力。他们的理想恋爱是纯精神的。";
	TRP2_LOC_Luxurieux = "好色";
	TRP2_LOC_Luxurieux_TT = "{c}\"满脑子都是性，是在说我吗?\"\n{o}永远搜寻着快感, 任何快感, 他们离不开放荡的生活。\n好色之徒有过数不清的情人，并不对此感到羞愧。\n他们不会压抑他们疯狂的欲望，跟差不多任何人都能调的起情。";
	TRP2_LOC_Indulgent = "宽容";
	TRP2_LOC_Indulgent_TT = "他最喜欢说的应该是: {c}\"哦! 他们一定不是故意的。\"{o} 他们甚至可能会这样形容刚刚才杀光了他们的族人的军阀。\n宽容的人会原谅并忘却，不管是多么可怕的行为。\n他很少会去寻仇(基本上永远不会),并一直帮别人找借口。";
	TRP2_LOC_Rencunier = "记仇";
	TRP2_LOC_Rencunier_TT = "{c}\"等待着我的报复吧!\"\n{o}记仇的人至今还记恨着小时候欺负过他人。\n他们发誓报仇，并为此努力着。\n{c}\"以牙还牙\"{o}和{c}\"君子报仇，十年不晚\" {o}成了他们的格言。\n为了确保他们永远不会忘记，他们将所有冒犯过他们的人的名单记在小本子上，详细列出他们罪过，和他们犯错的具体日期。";
	TRP2_LOC_Genereux = "无私";
	TRP2_LOC_Genereux_TT = "他们心胸宽广，必须与他人分享他们所有的一切。\n他们会把身上的衬衫送给你（如果你要的话），并花光自己所有的血汗钱。\n他们经常过度的赠送自己的东西：{c}\"我当然可以把衬衫和裤子都给你。反正我很热。 \".\n{o}他们会不求任何回报的给予。";
	TRP2_LOC_Egoiste = "自私";
	TRP2_LOC_Egoiste_TT = "他们只想着自己。\n如果他们手上有两个苹果，他们宁可两个都留着，也不会分给街上那挨饿的乞丐。\n{c}\"吝啬鬼\"{o} 也许是他们的外号。他们将个人利益放的比一切都高。\n他们所作的一切都只有一个目：利己。\n别人的问题让他们自己解决去……";
	TRP2_LOC_Sincere = "诚实";
	TRP2_LOC_Sincere_TT = "他们从不撒谎。\n从不。\n如果有人问: {c}\"亲爱的，我的新发型怎么样?\"{o} 他们很可能会回答: {c}\"嗯, 亲爱的, 你看上去像头公牛与患有白化病的公羊的杂交产物。\"{o}.\n他们总会实话实说，不管是好话还是坏话。\n这也许会导致某些人的自尊受伤。\n他们无论在朋友或敌人面前都是如此，并对此毫无掩饰。";
	TRP2_LOC_Trompeur = "虚假";
	TRP2_LOC_Trompeur_TT = "他们的另一种称呼是{j}\"病态说谎癖患者\"{o}.\n可千万不要相信那些美好的言语；那只是他们在试图让你相信一些并不存在的东西。 \n大多数虚假的人都十分狡猾，会通过操控他人以达成自己的目的。";
	TRP2_LOC_Misericordieux = "温柔";
	TRP2_LOC_Misericordieux_TT = "{c}\"爱人如爱己\" {o}也许是他们的座右铭。\n他们宁愿{j}\"要爱，不要战争\"{o}，并反对任何形式的暴力。\n比如说，他们绝不会去拍死那只几小时来都吸着他们的血的虫子。\n他们喜欢安静、柔软的音乐，白色的小猫咪，鲜花，和唱歌的小鸟；偶尔会调制一些物质来带给他们美好的梦境……”";
	TRP2_LOC_Cruel = "蛮横";
	TRP2_LOC_Cruel_TT = "他们不知道什么叫温柔或友善。\n他们为达到目的，可以不择手段，这包括拷问和虐待。\n他们会以不可阻挡的蛮力来解决纠纷。\n他们大概会出手打站在他们道路中的小孩。\n对他们来说，任何事情都可以成为打架的借口。暴力越多，他们就越开心。";
	TRP2_LOC_Modeste = "谦逊";
	TRP2_LOC_Modeste_TT = "{c}\"Don't mention it. It's natural. You would have done the same.\"{o}That's what they'd tell a family after saving their lives.\nThey don't derive any personal glory from feats of arms or services rendered.\nThey don't feel the need to advertise every good deed they perform. They can even be uncomfortable when other people mention their altruism and bravery.";
	TRP2_LOC_Vantard = "吹嘘";
	TRP2_LOC_Vantard_TT = "Whenever they accomplish anything, the whole town hears about it for weeks.\nEven small things like changing socks (well, that's no small thing to them) or spelling their own names, all of that will be broadcast widely.\nOne of their favourite quotes is {c}\"Oh but I know a few things you don't\"{o}, which they say while puffing up their chest with importance.\nMost of the time, nobody listens. But they don't mind. They like the sound of their own voices.";
	TRP2_LOC_Pieux = "虔诚";
	TRP2_LOC_Pieux_TT = "{c}\"感谢圣光赐我雨水浇灌粮食!\"\n{o}他们身上发生的一切都是某些强大的神明安排的。这就是虔诚者的思维模式。\n他们时常赞颂{c}\"治理世界、决定我们命运的上级存在\"{o}。他们拒绝细想，也许他们的信仰和宗教仪式并没什么作用。\n他们脑子里只有：{c}\"我们的神明无所不能，我们必须做每日的敬奉。\"{o} ";
	TRP2_LOC_Pragmatique = "叛逆";
	TRP2_LOC_Pragmatique_TT = "只要能迅速并有效的解决问题，叛逆者并不介意违背法律或道德准则。\n{j}\"为正当目的可不择手段\"{o}是他们的原则。";
	TRP2_LOC_Conciliant = "典范";
	TRP2_LOC_Conciliant_TT = "典范类人物会在遵守个人法律和道德约束的同时达成目标。对他来说，荣耀比什么都重要。";
	TRP2_LOC_Rationnel = "理智";
	TRP2_LOC_Rationnel_TT = "{c}\"今天风大，天空布满乌云。应该快下雨了。这会有益于我的收成。\"{o}\n理智的人可不在乎那些看管我们的神明。\n他们知道世事都是一连串的因果效应，并且能以演示证明。\n他们认为虔诚者都是些落后的狂热疯子。他们会去研究鲑鱼迁移习惯，而不会相信它们只是在特定时刻魔法般的出现。";
	TRP2_LOC_Reflechi = "谨慎";
	TRP2_LOC_Reflechi_TT = "谨慎的人永远从容不乱，在做决定之前先衡量每一个选择，在脑中预想好它们的结果。\n在战斗中，他们不会率先出击；比起盲目冲入战斗，他们更喜欢先评估好自己该先拿下哪一个敌人。";
	TRP2_LOC_Impulsif = "冲动";
	TRP2_LOC_Impulsif_TT = "{c}\"那边的女士被抢了，快点!\"\n{o}冲动者会直接冲向前去帮助他们眼中的受害者。\n他们没时间考虑到，那位女士其实是个老练的小偷，而那男人只是在试图夺回自己的东西。\n冲动者会迅速的做出不经大脑的决定，先{j}\"行动\"{o}再{j}\"评价\".\n{o}这既是优点也是缺点。他们的冲动既能在关键时刻救命，也能适得其反。";
	TRP2_LOC_Acete = "苦行";
	TRP2_LOC_Acete_TT = "一片面包，一杯清水，这对苦行主义者来说已经足够了。\n他们的目标是通过肉体上的磨练，来达到灵魂境界的觉悟。\n他们会严控他们的身体和思想，抵挡世俗间的诱惑。\n别费工夫请他们吃大餐或者相赠时髦衣物了。他们不但会不为所动，还会提醒你他们的灵魂远比舒适重要。";
	TRP2_LOC_Bonvivant = "享乐";
	TRP2_LOC_Bonvivant_TT = "享乐主义者热爱美食和红酒。\n再给他们来点令人愉快的同伴，他们会直接快活死。\n他们会抛开忧愁，毫无顾忌的享受人生\n他们会不顾一切的玩乐，因为他们永远不知道{c}\"明天会带来什么\"{o}。";
	TRP2_LOC_Valeureux = "勇敢";
	TRP2_LOC_Valeureux_TT = "面对的恶龙越大越可怕，勇敢者便会提起越多的勇气。\n举起长剑，喝起战吼，他们会毫无犹豫的冲向敌人。\n那荒凉悬崖上的地牢中关着一位公主?他会徒手爬上去，即使他患有恐高症。\n除了死亡，没什么能够阻挡他。";
	TRP2_LOC_Couard = "懦弱";
	TRP2_LOC_Couard_TT = "摔门声能把懦弱者吓得藏到床底下。\n他们什么都怕，这包括他们自己的影子和睡觉时的鼾声。\n他们无法直视敌人的双眼。一般情况下，敌人只能看到他们落荒而逃的背影。\n他们最喜欢说的是：\n{c}\"你给我证明这森林里没有比成年兔子更可怕的生物，我才同意去睡觉。\"{o}\n他们是真正的胆小鬼，在战斗中宁可逃跑。";
	TRP2_LOC_Actuellement = "当前";
	TRP2_LOC_TITRE = "称号";
	TRP2_LOC_TITRE_TT = "{o}你的人物经常被人使用的称号。"
								.."请避免过长的称号。过长的称号可以标注到完整称号栏目中。\n\n示例： {v}{o}\n{v}伯爵夫人,\n"
								.."{v}侯爵,\n{v}大法师,\n{v}领主,\n{v}etc.\n{o}{r}不适当的称号{o}:\n{r}北部沼泽伯爵夫人,\n{r}暴风塔大法师,\n{r}德莱尼政府大使,\n{r}etc.";
	TRP2_LOC_PRENOM = "名字";
	TRP2_LOC_PRENOM_TT = "{o}这是你的人物的名字。如果没有特定的话，人物系统名("..TRP2_Joueur..")将用作为名字。"
								.."\n\n你也可以使用{v}外号{o}!";
	TRP2_LOC_NOM = "姓氏";
	TRP2_LOC_NOM_TT = "这是你的人物的姓氏。可选择填写。";
	TRP2_LOC_DETAILVISAGE = "面部特征";
	TRP2_LOC_VISAGETRAIT = "五官";
	TRP2_LOC_VISAGETRAIT_TT = "这里是人物的面部特征。比方说，他的五官也许不叫粗糙。"
									.."这也是你该提到面部疤痕的地方。不过，这些应该是永久的特征，而不是暂时性的。";
	TRP2_LOC_VISAGEYEUX = "眼睛颜色";
	TRP2_LOC_VISAGEYEUX_TT = "在这里注明人物眼睛的颜色。即使你的人物脸一直被遮着，也许还是有必要注明的，以往万一嘛。";
	TRP2_LOC_VISAGEPIERCING = "刺洞/纹身";
	TRP2_LOC_VISAGEPIERCING_TT = "可以在这里描述人物任何的刺洞或纹身。";
	TRP2_LOC_SOUSTITRE = "完整称号";
	TRP2_LOC_SOUSTITRE_TT = "可以再这里填写人物的完整称号。他既可以是以上称号的加长版本，也可以是一个全新的称号。\n\n不过,你该尽量避免过度的重复，"
									.." 特别是没有什么新的信息的话。";
	TRP2_LOC_AGE = "年龄";
	TRP2_LOC_AGE_TT = "在这里注明人物的年龄。\n\n这有好几种方式:\n- 可以使用年数,\n- 或者形容词 (比如说：年轻, 成年, 中年, 之类的.).";
	TRP2_LOC_ORIGINE = "出生地";
	TRP2_LOC_ORIGINE_TT = "在这里注明人物的出生地。这可以使地区，地域，甚至是整个大陆。你可以自行决定要写的多具体。当然了，这个栏目是选填的。";
	TRP2_LOC_HABITAT = "居住地";
	TRP2_LOC_HABITAT_TT = "可以在这里注明你的人物一般在哪里居住。这可以使他的个人地址，或者他\"借宿\"的地方。"
								.."\n\n这个栏目也是选填的。你的人物也许无家可归，作个流浪汉……";
	TRP2_LOC_RACE = "种族";
	TRP2_LOC_RACE_TT = "这里是人物的种族。它并不一定要局限于官方设定的可玩种族。WoW世界中有很多可以有着普通形态的种族……";
	TRP2_LOC_PHYSIQUE = "身体特征";
	TRP2_LOC_DETAILREG = "通讯录信息";
	TRP2_LOC_TAILLE = "身高";
	TRP2_LOC_SILHOUETTE = "体型";
	TRP2_LOC_MORALE = "道德信念";
	TRP2_LOC_ETHIQUE = "伦理观";
	TRP2_LOC_ALIGNEMENT = "Alignment";
	TRP2_LOC_PsyPerso = "个人";
	TRP2_LOC_TAILLE_TEXTE = {};
	TRP2_LOC_TAILLE_TEXTE[1] = "极矮";
	TRP2_LOC_TAILLE_TEXTE[2] = "矮小";
	TRP2_LOC_TAILLE_TEXTE[3] = "中等";
	TRP2_LOC_TAILLE_TEXTE[4] = "高挑";
	TRP2_LOC_TAILLE_TEXTE[5] = "极高";
	TRP2_LOC_SILHOUETTE_TEXTE = {};
	TRP2_LOC_SILHOUETTE_TEXTE[1] = "超重";
	TRP2_LOC_SILHOUETTE_TEXTE[2] = "普通";
	TRP2_LOC_SILHOUETTE_TEXTE[3] = "健壮";
	TRP2_LOC_SILHOUETTE_TEXTE[4] = "消瘦";
	TRP2_LOC_GUILD_TT = "{o}%2的{w}%1";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	--  REGISTRE
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_ListeRegistre = "纪录列表";
	TRP2_LOC_DontSaveChanges = "不保存改变";
	TRP2_LOC_ListeRegistre_TT = "返回通讯薄人物列表。";
	TRP2_LOC_RegVide = "通讯薄空空如也";
	TRP2_LOC_SelectVide = "选择\n为空";
	TRP2_LOC_ConnectNow = "在线";
	TRP2_LOC_ConnectSmall = "只显示在线";
	TRP2_LOC_DateAjout = "纪录时间";
	TRP2_LOC_ConnectOnly = "只显示目前在线的人物。";
	TRP2_LOC_RegAdd = "%1被加入了通讯薄";
	TRP2_LOC_AccessLevel = "信任值";
	TRP2_LOC_AccessLevelAll = "全部";
	TRP2_LOC_AccessLevelIgnored = "已屏蔽";
	TRP2_LOC_DeletePerso = "将%1从通讯薄中删除";
	TRP2_LOC_DeleteRegConfirm = "确定要将%1从通讯薄中删除?";
	TRP2_LOC_RelationChange = "编辑关系";
	TRP2_LOC_AccessChange = "编辑信任值";
	TRP2_LOC_Filtres = "过滤";
	TRP2_LOC_PlayerIcon = "人物图签";
	TRP2_LOC_ConsulterFiche = "浏览人物卡";
	TRP2_LOC_DELETEPETS = "{w}是否删除坐骑{v}%1{w}的信息(通讯薄和状态)?";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	--  AURAS
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_AuraCaract = "状态";
	TRP2_LOC_NewAura = "新状态";
	TRP2_LOC_Aura_Error_1 = "{o}你不再有此状态的信息";
	TRP2_LOC_Aura_Error_2 = "{o}你没有开启数据库组件。\n使用此状态需要该组件。";
	TRP2_LOC_Aura_Error_3 = "{o}此状态来与更新版本的数据库组件\n请更新数据库。";
	TRP2_LOC_Aura_Error_4 = "{r}状态无法添加，因为人物已经有15个状态了。";
	TRP2_LOC_ChoixDuree = "持续时间";
	TRP2_LOC_ChoixObjet = "物品选项";
	TRP2_LOC_NoDelete = "无法手动删除它";
	TRP2_LOC_AuraNum = "{r}状态n°%1";
	TRP2_LOC_AuraRemove = "移除状态";
	TRP2_LOC_AuraRemoveSure = "你是否要从人物%2身上移除状态%1?";
	TRP2_PET_AURAS = "小伙伴的状态";
	TRP2_LOC_AuraType = {};
	TRP2_LOC_AuraType[1] = "{r}减益";
	TRP2_LOC_AuraType[2] = "{w}普通";
	TRP2_LOC_AuraType[3] = "{v}增益";
	TRP2_LOC_AuraDeleteNot = "{j}%2失去了%1{j}.";
	TRP2_LOC_AuraAjoutNot = "{j}%2得到了%1{j}.";
	TRP2_LOC_AuraTimeDemand = "{j}状态:\n{v}[%1]{o}的持续时间。\n\n{w}请输入人物%2状态的持续时间。\n{o}0 "
									.."意味着无限{w}(持续直到被玩家手动清除).";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	--  JOURNAL
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_Date = "日期";
	TRP2_LOC_NO_ICON = "无图标";
	TRP2_LOC_LIST_ICON = "图标列表";
	TRP2_LOC_NO_AURAS = "无状态";
	TRP2_LOC_LIST_AURAS = "状态列表";
	TRP2_LOC_NO_ENTRY = "无记录";
	TRP2_LOC_ICON_CHOIX = "选择图标";
	TRP2_LOC_ICON_REINIT = "重设图标";
	TRP2_LOC_SOUND_CHOIX = "选择音效";
	TRP2_LOC_APERCU = "预览";
	TRP2_LOC_CONSULTER = "浏览";
	TRP2_LOC_SAVEAS = "另存为";
	TRP2_LOC_MENU = "菜单";
	TRP2_LOC_ACTIVER = "激活";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	...
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_PARAMS = "设置";
	TRP2_LOC_PAR_GENERAL = "常规设置";
	TRP2_LOC_PAR_ICONE = "按钮设置";
	TRP2_LOC_PAR_ICONEMM = "主按钮";
	TRP2_LOC_PAR_ICONEREG = "肖像按钮";
	TRP2_LOC_PAR_ETATSAFFI = "目标状态";
	TRP2_LOC_PAR_MMRotation = "旋转主按钮";
	TRP2_LOC_PAR_ICOTARPOSX = "位置: X";
	TRP2_LOC_PAR_ICOTARPOSY = "位置: Y";
	TRP2_LOC_PAR_MMRotationTT = "   决定TotalRP2按钮在框架上的位置。";
	TRP2_LOC_PAR_MMPosition = "主按钮位置";
	TRP2_LOC_PAR_MMPositionTT = "   决定TotalRP2按钮与其定位框架的距离。";
	TRP2_LOC_PAR_MMtoUse = "框架名称";
	TRP2_LOC_PAR_MMtoUseTT = "   决定主按钮定位在哪个框架上的。\n默认框架为暴雪界面中的迷你地图。"
								.." \n\n    如果输入的框架名称不存在，红色字体会显示{r}(Ouch!)";
	TRP2_LOC_PAR_MMtoUseMM = "你并不一定要使用迷你地图框架!你也可以试试人物框架(PlayerFrame)。"
								.." 这样会将主按钮挪到人物界面边上。";
	TRP2_LOC_PAR_InvFrame = "系统信息";
	TRP2_LOC_PAR_InvFrameRP = "IC信息";
	TRP2_LOC_PAR_ChoozenFrame = "有效窗口";
	TRP2_LOC_PAR_InvFrameTT = "   决定显示TRP2的系统信息的聊天窗口。(通知,"
									.." 错误, 提警告, etc).\n\n"..TRP2_LOC_PAR_ChatFrameExplication;
	TRP2_LOC_PAR_InvFrameRPTT = "   决定显示TRP2{v}IC{o}消息的聊天窗口。 (消息, 表情"
									..", 任何与人物和他的动作相关的信息).\n\n"..TRP2_LOC_PAR_ChatFrameExplication;
	TRP2_LOC_PAR_HRPFrameTT = "决定显示OOC信息的聊天窗口。\n\n"..TRP2_LOC_PAR_ChatFrameExplication;
	TRP2_LOC_PAR_DebugCheck = "调试模式";
	TRP2_LOC_PAR_Debug = "Debug";
	TRP2_LOC_PAR_DebugCheckTT = "   显示故障信息。\n可在测试时使用。";
	TRP2_LOC_PAR_DebugFrame = "Debug信息";
	TRP2_LOC_PAR_SoundLog = "激活音效log";
	TRP2_LOC_PAR_SoundLogTT = "在聊天窗口中显示正在播放音效的玩家。这样你可以找到并屏蔽某些无聊的人。";
	TRP2_LOC_PAR_SoundFrame = "Log窗口";
	TRP2_LOC_PAR_DebugFrameTT = "   决定显示Debug信息的聊天窗口。 (通知,"
									.." 错误, 警告, etc).\n\n"..TRP2_LOC_PAR_ChatFrameExplication;
	TRP2_LOC_PAR_SoundFrameTT = "   决定显示音效Log的聊天窗口。\n\n"..TRP2_LOC_PAR_ChatFrameExplication;
	TRP2_LOC_PAR_AideOption = "帮助&提示";
	TRP2_LOC_PAR_AideTaille = "帮助文字大小";
	TRP2_LOC_PAR_AideTailleTT = "决定TRP2鼠标提示框内的文字大小。";
	TRP2_LOC_PAR_ChannelToUse = "广播频道";
	TRP2_LOC_PAR_ChannelToUseNom = "频道名称";
	TRP2_LOC_PAR_TTPersoTT = "名称大小";
	TRP2_LOC_PAR_TTPersoTI = "信息大小";
	TRP2_LOC_PAR_TTPersoTD = "描述大小";
	TRP2_LOC_PAR_DefautAcces = "默认信任值";
	TRP2_LOC_PAR_AutoNew = "自动添加";
	TRP2_LOC_PAR_NotifyNew = "添加时提醒";
	TRP2_LOC_PAR_CouperApresChat = "注释太长的话，将被剪裁。";
	TRP2_LOC_PAR_CouperNotesChat = "剪裁注释";
	TRP2_LOC_By = "by";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- BARRE DE RACCOURCIS
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_RACCBAR = "Total RP 2";
	TRP2_LOC_CASQUE_AFF = "{j}Click{w}: 隐藏头盔";
	TRP2_LOC_CASQUE_CAC = "{j}Click{w}: 显示头盔";
	TRP2_LOC_CAPE_AFF = "{j}Click{w}: 隐藏披风";
	TRP2_LOC_CAPE_CAC = "{j}Click{w}: 显示披风";
	TRP2_LOC_RPTOHRP = "{j}Click{w}: 切换到{r}OOC状态{w}";
	TRP2_LOC_HRPTORP = "{j}Click{w}: 切换到{v}IC状态{w}";
	TRP2_LOC_RP_GOTO = "{j}你目前正处于{v}(IC状态){j}.";
	TRP2_LOC_HRP_GOTO = "{j}你目前正处于{r}(OOC状态){j}.";
	TRP2_LOC_TO_NORMAL = "{j}Click{w}: 切换到{v}正常{w}模式";
	TRP2_LOC_TO_ABS = "{j}Left-click{w}: 切换到{o}离开{w}模式";
	TRP2_LOC_TO_DND = "{j}Right-click{w}: 切换到{r}请勿打扰{w}模式";
	TRP2_LOC_ListeSons = "音效列表";
	TRP2_LOC_PasDeSons = "无音效";
	TRP2_LOC_PlaylistNum = "播放列表n°%1";
	TRP2_LOC_Playlist = "播放列表";
	TRP2_LOC_PlaylistSelect = "选择播放列表";
	TRP2_LOC_ShowHidePlaylist = "显示/隐藏 播放列表";
	TRP2_LOC_ShowHideList = "显示/隐藏 音效列表";
	TRP2_LOC_Sound_Add = "添加到播放列表";
	TRP2_LOC_Objet_Add = "添加到物品栏";
	TRP2_LOC_Sound_PlayChange = "换播放列表";
	TRP2_LOC_Sound_Remove = "从播放列表中删除";
	TRP2_LOC_Sound_PreListen = "预览音效";
	TRP2_LOC_Sound_PlayLocal = "播放音效 (本地)";
	TRP2_LOC_Sound_PlayGlobal = "播放音效 (队伍-RAID)";
	TRP2_LOC_Sound_EventAnim = "NPC对话";
	TRP2_LOC_Sound_NPCParleEmote = "让%1说话/做动作";
	TRP2_LOC_Sound_TexteSeul = "显示叙述文字";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- INVENTAIRE
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_NEWDOCU = "新文件";
	TRP2_LOC_INVENTAIRE = "物品栏";
	TRP2_LOC_PLANQUE = "储藏地";
	TRP2_LOC_NOTES = "注释";
	TRP2_LOC_PUBLIQUE = "公共";
	TRP2_LOC_PRIVEE = "私人";
	TRP2_LOC_COORD = "坐标";
	TRP2_LOC_PersonnagePerm = "已授权人物";
	TRP2_LOC_CREATE_PLANQUE = "储藏地%1创建成功。";
	TRP2_LOC_MODIF_PLANQUE = "储藏地%1修改成功。";
	TRP2_LOC_DELETE_PLANQUE = "储藏地%1移除成功。";
	TRP2_LOC_NEWPLANQUE = "新储藏地%";
	TRP2_LOC_SEARCHLANQUE = "在附近搜索储藏地";
	TRP2_LOC_OPENLANQUE = "使用你的储藏地";
	TRP2_LOC_CREATEPLANQUE = "在这里创建新储藏地";
	TRP2_LOC_MODIFPLANQUE = "修改你的储藏地";
	TRP2_LOC_ListeVosPlanque = "管理你的储藏地";
	TRP2_LOC_ListeLeurPlanque = "已找到的储藏地列表";
	TRP2_LOC_DELPLANQUETT = "是否移除此储藏地?\n{o}其中任何的物品或金币会被销毁。";
	TRP2_LOC_DELETEPLANQUE = "移除储藏地";
	TRP2_LOC_ALREADY_PLANQUE = "你已经在这里有储藏地了。";
	TRP2_LOC_POIDSBASE = "空重";
	TRP2_LOC_POIDSTOTAL = "总重量";
	TRP2_LOC_POIDSTOTAL_TT = "这是你的背包的总重量。它会略微影响某些属性，比如说呼吸和体力。";
	TRP2_LOC_SAC = "背包";
	TRP2_LOC_COFFRE = "箱子";
	TRP2_LOC_BOURSE = "荷包";
	TRP2_LOC_OR = "金钱";
	TRP2_LOC_MONTANT = "数量";
	TRP2_LOC_DESTROYOBJ = "{j}已从物品栏中删除: %2x%1";
	TRP2_LOC_BOURSE_TT = "随身所带的金钱数量。这些钱可能在一些情况下丢失。\n\n{o}如要将钱移到别处，只需像移动其他物品一样拖动金币。";
	TRP2_LOC_ORCOFFRE = "箱子中的金钱";
	TRP2_LOC_ORPLANQUE = "储藏地的金钱";
	TRP2_LOC_ORPLANQUE_TT = "储藏地中的金钱数量。一切可以使用此储藏地的玩家都可以挪用这些金钱。";
	TRP2_LOC_ORCOFFRE_TT = "箱子中的金钱数量。你无法丢失这里的钱。\n\n{o}如要将钱移到别处，只需像移动其他物品一样拖动金币。";
	TRP2_LOC_COFFR_ERROR_1 = "你目前无法使用你的储藏地。";
	TRP2_LOC_ObjetDeleteConfirm = "是否丢弃%1?";
	TRP2_LOC_AddGoldNote = "{j}被加入了你的物品栏: %1.";
	TRP2_LOC_DelGoldNote = "{j}被移出了你的物品栏: %1";
	TRP2_LOC_ObjectAddNote = "{j}被加入了物品栏: %2x%1";
	TRP2_LOC_GoldToSac = "将几枚铜币移入背包?";
	TRP2_LOC_GoldToCoffre = "将几枚铜币移入箱子?";
	TRP2_LOC_GoldToPlanque = "将几枚铜币移入储藏地?";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- OBJET
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_NEW_Objet = "新物品";
	TRP2_LOC_Objet_ChargesCount = "%1 |4消耗次数";
	TRP2_LOC_Objet_Error_2 = "{o}该物品属于更新版本的Total RP 2.\n请更新插件。";
	TRP2_LOC_Objet_Error_3 = "{o}你没有该物品的信息。";
	TRP2_LOC_Objet_Num = "{r}物品n°%1";
	TRP2_LOC_Objet_POIDS = "重量";
	TRP2_LOC_Objet_VALEUR = "价值";
	TRP2_LOC_Objet_LIFETIME = "寿命";
	TRP2_LOC_Objet_NODELETE = "无法丢弃此物品。";
	TRP2_LOC_Objet_NOCONDI = "你未达到使用此物品的要求。";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- SOURIS
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_CLIC = "单击";
	TRP2_LOC_CLICMAJ = "Shift+单击";
	TRP2_LOC_CLICCTRL = "Ctrl+单击";
	TRP2_LOC_CLICDROITCTRL = "Ctrl+右键";
	TRP2_LOC_CLICDROITMAJ = "Shift+右键";
	TRP2_LOC_CLICDROIT = "右键";
	TRP2_LOC_OPENMENU = "隐藏/显示 TRP2 窗口";
	TRP2_LOC_OPENRACC = "隐藏/显示工具栏";
	TRP2_LOC_RACC = "工具栏";
	TRP2_LOC_RACCAFF = "进入游戏时显示";
	TRP2_LOC_AlphaRaccBar = "工具栏透明度";
	TRP2_LOC_CloseCombat = "在战斗中关闭";
	TRP2_LOC_Notify = "有新版本时提示我";
	TRP2_LOC_CarnetNotes = "笔记本";
	TRP2_LOC_AfficherNom = "显示名称";
	TRP2_LOC_SendInfo = "发送信息";
	TRP2_LOC_SendInfoTT = "指定自定义内容的接收人。自定义内容:\n\n{o}[{v}%1{o}]\n";
	TRP2_LOC_SHOWID = "自定义内容ID";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- CHATFRAME ET DIALECTES
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_DIT = "说: ";
	TRP2_LOC_CRIE = "大喊: ";
	TRP2_LOC_WHISPER = "悄悄地说: ";
	TRP2_LOC_NEWDIALECTE = "新方言";
	TRP2_LOC_LanguesListe = "方言列表";
	TRP2_LOC_DialecteCompChoose = "{o}[{v}%1{o}]{w}\n指定该方言的新流利度(最高为100)";
	TRP2_LOC_NODIALECTES = "无方言";
	TRP2_LOC_DIALECTE = "方言";
	TRP2_LOC_DIALECTES = "方言";
	TRP2_LOC_TEXTE = "只显示文字";
	TRP2_LOC_CHATFRAME = "聊天窗口";
	TRP2_LOC_CHATDETECT = "侦察器";
	TRP2_LOC_HRPMODE = "OOC侦察器";
	TRP2_LOC_HRPMODETab = {};
	TRP2_LOC_HRPMODETab[1] = ADDON_DISABLED;
	TRP2_LOC_HRPMODETab[2] = "OOC颜色";
	TRP2_LOC_HRPMODETab[3] = "OOC窗口";
	TRP2_LOC_EMOTEMODE = "表情侦察器";
	TRP2_LOC_EMOTEMODETab = {};
	TRP2_LOC_EMOTEMODETab[1] = "已关闭";
	TRP2_LOC_EMOTEMODETab[2] = "表情颜色";
	TRP2_LOC_EMOTEMODETab[3] = "表情剪切";
	TRP2_LOC_TRACEINCHAT = "追溯作者";
	TRP2_LOC_PNJMODE = "NPC对话探查器";
	TRP2_LOC_PNJMODETab = {};
	TRP2_LOC_PNJMODETab[1] = ADDON_DISABLED;
	TRP2_LOC_PNJMODETab[2] = "已开启";
	TRP2_LOC_CHATFRAMEGEST = "显示/隐藏笔记本";
	TRP2_LOC_DeleteDialecteConfirm = "是否遗忘{o}[{v}%1{o}]{w}?\n同时将重设流利度。";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- Texte Mini-Me
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_SP_PHRASE_SUR = "是否确定?";
	TRP2_LOC_OPEN_HELP = "打开使用手册";
	TRP2_LOC_BOURSE_MM = "不要养成随身携太太多金钱的习惯。你可能会成为小偷和强盗的目标!";
	TRP2_LOC_ORCOFFRE_MM = "你的金币在这里已经很安全了!";
	TRP2_LOC_ALIGN_TIPS = "Remember that the {c}Alignment|r that you choose for me is a guideline. That means you can decide to stray from it. "
								.."It's no big deal. But don't make a habit out of it, otherwise that would mean you didn't choose the right alignment!";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- CREATIONS
	...
	TRP2_LOC_AuraCibleTab = {};
	TRP2_LOC_AuraCibleTab[1] = PLAYER;
	TRP2_LOC_AuraCibleTab[2] = "坐骑";
	TRP2_LOC_AuraCibleTab[3] = PET;
	TRP2_LOC_AuraCibleTab[4] = "小伙伴";
	TRP2_LOC_CREA_AURA_SAVE = "{v}自定义内容{o}%1{v}保存成功。";
	TRP2_LOC_SAVEALERT = "请勿忘记保存更改!";
	TRP2_LOC_QUANTITE = "数量";
	TRP2_LOC_TOOLTIP_OBJET = "物品鼠标提示框";
	TRP2_LOC_AFFICHERSTAT = "显示数据";
	TRP2_LOC_CREATION = "自定义内容";
	TRP2_LOC_CREA_OBJET = "自定义物品";
	TRP2_LOC_CREA_DOCU = "自定义文件";
	TRP2_LOC_CREA_EVENT = "自定义任务";
	TRP2_LOC_CREA_AURA = "自定义状态";
	TRP2_LOC_CREA_LANG = "自定义方言";
	TRP2_LOC_CATEGORIES = "分类";
	TRP2_LOC_DEL_REF_OBJ = "{w}请确认删除关于%1{w}的信息?";
	TRP2_LOC_ADD_OBJ = "%1\n{w}将几个单元移入背包中?";
	TRP2_LOC_TRIGOBJ_RECEIVE = "接收时";
	TRP2_LOC_TRIGOBJ_TIMEOUT = "寿命结束时";
	TRP2_LOC_TRIGOBJ_COOLDOWN = "冷却结束时";
	TRP2_LOC_TRIGOBJ_DESTROY = "销毁时";
	TRP2_LOC_TRIGOBJ_USESTART = "使用时 (start)";
	TRP2_LOC_TRIGOBJ_USESTARTF = "使用失败时 (start)";
	TRP2_LOC_TRIGOBJ_USEEND = "使用时 (end)";
	TRP2_LOC_TRIGOBJ_USEENDF = "使用失败时 (end)";
	TRP2_LOC_TRIGOBJ_GIVE = "交易时";
	TRP2_LOC_TRIGOBJ_USED = "耗尽时";
	TRP2_LOC_FNC = "合取范式";
	TRP2_LOC_CONDITIONS = "条件";
	TRP2_LOC_EFFETS = "效果";
	TRP2_LOC_ICONEOBJ = "图标";
	TRP2_LOC_CHARGES = "消耗次数";
	TRP2_LOC_ACTIONNAME = "动作名称";
	TRP2_LOC_ACTIONTEXT = "执行名称";
	TRP2_LOC_DUREETEXT = "使用时间";
	TRP2_LOC_DUREEDEF = "默认持续时间";
	TRP2_LOC_DUREE = "持续时间";
	TRP2_LOC_RECHARGE = "冷却时间";
	TRP2_LOC_PILE = "堆叠";
	TRP2_LOC_FLAGS = "标示";
	TRP2_LOC_FLAG = "标示";
	TRP2_LOC_USABLE = "可使用";
	TRP2_LOC_DESTROYABLE = "可销毁";
	TRP2_LOC_TRIGGERS = "触发";
	TRP2_LOC_INFOSUPP = "附加信息";
	TRP2_LOC_INFOGENERAL = "常规信息";
	TRP2_LOC_UTILISATION = "使用";
	TRP2_LOC_MANUAL = "可添加";
	TRP2_LOC_WRITELOCK = "编辑锁";
	TRP2_LOC_READLOCK = "查看锁";
	TRP2_LOC_GIVABLE = "可交易";
	TRP2_LOC_STOLABLE = "固定";
	TRP2_LOC_TIMESET = "选择持续时间";
	TRP2_LOC_DELETABLE = "可删除";
	TRP2_LOC_CREATOR = "作者";
	TRP2_LOC_SECONDS = "持续";
	TRP2_LOC_LASTDATE = "最新版本";
	TRP2_LOC_MANUALTEXT = "该物品可以被手动添加于你的物品栏中：将它拖动到空的物品栏中。"
								.."\n你也可以Shift+单击它，选择一次性添加的数量。";
	TRP2_LOC_SEEINFOEDIT = "浏览/编辑物品";
	TRP2_LOC_DELETEINFO = "删除物品";
	TRP2_LOC_SHOWIDTT = "显示ID";
	TRP2_LOC_CLICALT = "Alt+单击";
	TRP2_LOC_EFFETCONDIEDIT = "编辑触发";
	TRP2_LOC_CONDICONSTRUCTOR = "条件设定";
	TRP2_LOC_MODIFICATEURS = "修饰语";
	TRP2_LOC_AFFICHTEXTEB = "显示文字";
	TRP2_LOC_TEXTETYPE = {};
	TRP2_LOC_TEXTETYPE[1] = "聊天窗口";
	TRP2_LOC_TEXTETYPE[2] = "跳出窗口";
	TRP2_LOC_TEXTETYPE[3] = "警告";
	TRP2_LOC_TEXTETYPE[4] = "任务";
	TRP2_LOC_COMBATMODIF = "使用F.O.D.";
	TRP2_LOC_AURANOMTT = "这是状态的名称。\n你可以在名称前加上分类，以便于搜索。\n\n比如说：\n{v}心情：沮丧\n\n{o}名称中无法使用颜色Tag，因为颜色决定于状态的种类。";
	TRP2_LOC_DUREEDEFAUTTT = "这是该状态的默认持续时间(秒)。前提：被玩家手动添加，并且不允许选择持续时间。(标示{j}\"选择持续时间\"{o})。";
	TRP2_LOC_AURADESCRITT = "这是该状态的描述，显示于鼠标提示窗口中。\n\n最好给每个状态都写上描述，让其他人了解它的含义。"
									.."\n\n{r}警告: {w}请避免第二人称称呼 (你)! {j}请使用第三人称 (单数) 来称呼状态的拥有者。{w} 这样，其他玩家就不会觉得该描述是在特指他。另外，最好避免使用“他”或“她”。建议：这个角色，这个人，这个存在……";
	TRP2_LOC_TYPE = "种类";
	TRP2_LOC_TYPEAURATT = "状态的种类决定其效果对人物是有益，有害，还是中性的。这既可以是身体上的效果，也可以使精神上的。";
	TRP2_LOC_SAVEAURA = "保存该自定义内容的信息。\n这会同时更新它的版本号和更新日期。";
	TRP2_LOC_CLOSECREA = "返回自定义内容列表。\n\n{v}请不要忘记保存修改内容。";
	TRP2_LOC_SAVEASAURA = "以新的{v}ID{o}保存该自定义内容。 (你基本上是在创建一个有着同样信息的新自定义内容。)";
	TRP2_LOC_READLOCKTT = "The read-lock prevents any player other than the author to access this window and see the creation information.\n\n{v}It is {o}unadvised{v} to enable this flag because it prevents other players to learn how you built your creation, and prevents them to copy your creation (as they won't be able to access the \"Save as\" button).";
	TRP2_LOC_WRITELOCKTT = "编辑锁会禁止(除作者外的)其他玩家保存该自定义内容的信息。\n这不会禁止\"另存为\"功能。\n\n{v}强烈{o}不建议{v}{r}禁用{v}这个选项! 如果有其他人修改了你的自定义内容，所有人，包括你自己，都会收到更新，因为该自定义内容会保留同一个ID。";
	TRP2_LOC_AURADELETETT = "开启这个选项，将允许玩家通过人物卡来手动移除该状态。这只限于人物，不包括小伙伴。\n\n{v}如果你选择禁用这个选项，不要忘了设置其他消除状态的方式哦。";
	TRP2_LOC_AURAAJOUTTT = "开启这个选项，将允许玩家通过人物卡来手动添加该状态。";
	TRP2_LOC_TIMESETTT = "开启这个选项，将允许玩家在手动添加状态时，选择该状态的持续时间。";
	TRP2_LOC_COMBATMODIFTT = "开启这个选项，将允许战斗结果预测器(F.O.D.)在决定次等分数时包括此状态。\n\n每个{r}减益{o}状态会降低1点分数。\n\n每个{v}增益{o}状态会增加1点分数。";
	TRP2_LOC_AURARECEIVETT = "事件于添加状态时触发(不管是否为手动添加)。\n该事件只影响人物，不包括小伙伴。\n\n";
	TRP2_LOC_AURADESTROYTT = "事件于状态在持续时间结束前，被移除时触发(不管是否为手动移除)。\n该事件只影响人物，不包括小伙伴。\n\n";
	TRP2_LOC_AURALIFETIMETT = "事件于持续时间结束时触发。\n该事件只影响人物，不包括小伙伴。\n\n";
	TRP2_LOC_AURASECONDETT = "事件于人物带有状态时每秒触发。\n该事件只影响人物，不包括小伙伴。\n\n";
	TRP2_LOC_AJOUTEFFET = "添加新的效果";
	TRP2_LOC_AJOUTCONDI = "添加新的条件";
	TRP2_LOC_TEXTUELLE = "文字值";
	TRP2_LOC_TEXTUELLETT = "这个值会被当做文字。";
	TRP2_LOC_NUMERIC = "数值";
	TRP2_LOC_NUMERICTT = "这个值会被当做数字。";
	TRP2_LOC_CREAIDHELP = "ID";
	TRP2_LOC_CREAIDHELPTT = "ID是TRP2辨别自定义内容的唯一方式。它在自定义内容被创建时成成，之后便无法更改。ID的前三个字母代表该内容的种类。";
	TRP2_LOC_CREADATEHELP = "日期";
	TRP2_LOC_CREADATEHELPTT = "这是该自定义内容最后一次被保存的日期。如果没有使用编辑锁的话，这里也记载着保存该内容的玩家名称。(日期格式：日/月/年)";
	TRP2_LOC_CREAVERNHELP = "版本号";
	TRP2_LOC_CREAVERNHELPTT = "版本号将在内容被保存时更新。这样便可以判断玩家是否拥有过旧的版本。在某些情况下，TRP2会在多个玩家解除时自动更新自定义内容。";
	TRP2_LOC_CREAAuteurHELP = "原作者";
	TRP2_LOC_CREAAuteurHELPTT = "这是该自定义内容第一个版本的作者。这个原作者无法改动，即使有其他玩家编辑并保存了该自定义内容。{v}所以，一定要启用编辑锁!";
	
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- Quetes
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_CREZTEQUEST = "自定义任务";
	TRP2_LOC_NEWQUEST = "新任务";
	TRP2_LOC_QUESTLOG = "任务日志";
	TRP2_LOC_DeleteQuestAsk = "{w}是否放弃该任务\n%1{w} ?\n任何任务物品将被销毁。";
	TRP2_LOC_DeleteQuestAgree = "{j}任务%1{j}已被放弃。";
	TRP2_LOC_ReinitQuestAsk = "{w}是否重设任务\n%1{w} ?\n该任务所有已获取的任务物品将被丢弃。";
	TRP2_LOC_ReinitQuestAgree = "{j}任务%1{j}已被重设。";
	TRP2_LOC_STARTQUEST1 = "{j}你开始了任务%1{j}.";
	TRP2_LOC_ACTIVE = "有效任务";
	TRP2_LOC_NOACTIVE = "你没有有效任务。";
	TRP2_LOC_NoQuest = "无\n任务";
	TRP2_LOC_QUITQUEST = "放弃任务";
	TRP2_LOC_REINITQUEST = "重设任务";
	TRP2_LOC_QUESTERROR1 = "错误: 你没有该任务的信息!";
	TRP2_LOC_ACTIVEASSIGN = "设为有效任务";
	TRP2_LOC_ACCOMPLISHED = "已完成任务";
	TRP2_LOC_FAILED = "失败任务";
	TRP2_LOC_ETAPE = "步骤";
	TRP2_LOC_NOETAPE = "无\n步骤";
	TRP2_LOC_DERNIEREMENT = "最近";
	TRP2_LOC_NODESCR = "为描述";
	TRP2_LOC_ETAPES = "步骤";
	TRP2_LOC_REINIT = "重设";
	TRP2_LOC_ETAPESID = "步骤ID";
	TRP2_LOC_DELETEETAPE = "{w}是否删除步骤{o}%1{w}?";
	TRP2_LOC_DELETEACTION = "{w}是否删除动作{o}%1{w}?";
	TRP2_LOC_DELETEEFFET = "{w}是否移除效果{o}%1{w}?";
	TRP2_LOC_DELETECONDI = "{w}是否移除条件{o}%1{w}?";
	TRP2_LOC_QUESTMARK = {};
	TRP2_LOC_QUESTMARK[1] = "无";
	TRP2_LOC_QUESTMARK[2] = "失败";
	TRP2_LOC_QUESTMARK[3] = "成功";
	TRP2_LOC_ACTION = "动作";
	TRP2_LOC_NOACTION = "无\n动作";
	TRP2_LOC_ACTIONS = "动作";
	TRP2_LOC_QUESTACTION = {};
	TRP2_LOC_QUESTACTION[1] = "看";
	TRP2_LOC_QUESTACTION[2] = "说话";
	TRP2_LOC_QUESTACTION[3] = "听";
	TRP2_LOC_QUESTACTION[4] = "搜查";
	TRP2_LOC_NOEFFET = "无\n效果";
	TRP2_LOC_NOCONDI = "无\n条件";
	TRP2_LOC_Observer = "看";
	TRP2_LOC_Fouiller = "搜查";
	TRP2_LOC_Dire = "说话";
	TRP2_LOC_Ecouter = "听";
	TRP2_LOC_NOLOOK = "你没看到什么值得注意的。";
	TRP2_LOC_NOEAR = "你没听到什么值得注意的。";
	TRP2_LOC_NODIGG = "你没找到什么值得注意的。";
	TRP2_LOC_NOTALK = "这个人没什么想对你说的。";
	TRP2_LOC_PAROLES = "说";
	TRP2_LOC_URLSON = "存取路径";
	TRP2_LOC_PORTESON = "到达";
	TRP2_LOC_MODESON = {};
	TRP2_LOC_MODESON[1] = "个人";
	TRP2_LOC_MODESON[2] = "本地";
	TRP2_LOC_MODESON[3] = "全局(队伍-Raid)";
	TRP2_LOC_MODEETAPE = {};
	TRP2_LOC_MODEETAPE[1] = "什么都不做";
	TRP2_LOC_MODEETAPE[2] = "问";
	TRP2_LOC_MODEETAPE[3] = "强迫";
	TRP2_LOC_ALIGNVTOP = "上";
	TRP2_LOC_ALIGNVMIDDLE = "中";
	TRP2_LOC_ALIGNVBOTTOM = "下";
	TRP2_LOC_ALIGNHLEFT = "左";
	TRP2_LOC_ALIGNHCENTER = "居中";
	TRP2_LOC_ALIGNHRIGHT = "右";
	TRP2_LOC_DIMENSIONS = "尺寸";
	TRP2_LOC_MAINTEXT = "主文字";
	TRP2_LOC_TEXT = "文字";
	TRP2_LOC_ELEMLIST = "要素列表";
	TRP2_LOC_PAGELIST = "页面列表";
	TRP2_LOC_CADRELARG = "边框宽度";
	TRP2_LOC_CADREHAUT = "边框高度";
	TRP2_LOC_Position = "位置";
	TRP2_LOC_ALIGNEMENTV = "垂直对齐。";
	TRP2_LOC_ALIGNEMENTH = "水平对齐。";
	TRP2_LOC_FONT = "字体";
	TRP2_LOC_SPACINg = "间距";
	TRP2_LOC_Ombre = "投影";
	TRP2_LOC_Contours = "边框";
	TRP2_LOC_INFO = "信息";
	TRP2_LOC_Heigth = "高度";
	TRP2_LOC_Width = "宽度";
	TRP2_LOC_Rogner = "裁剪";
	TRP2_LOC_Couleurs = "颜色";
	TRP2_LOC_Couleur = "颜色";
	TRP2_LOC_Desaturer = "降低饱和度";
	TRP2_LOC_Arrondir = "圆形";
	TRP2_LOC_AlignDegrad = "渐变方向。";
	TRP2_LOC_AURAAjout = "添加状态";
	TRP2_LOC_AURAAjoutTT = "为人物添加状态。请注意，每人人物最多只能同时拥有15个状态。\n超过了这个数量的话，多余的状态将被取消。";
	TRP2_LOC_AURAAjoutTTPET = "为小伙伴添加状态。请注意，每个小伙伴最多只能同时拥有5个状态。\n超过了这个数量的话，多余的状态将被取消。";
	TRP2_LOC_Combats = "战斗";
	TRP2_LOC_SoundURL = TRP2_ENTETE.."{w}请输入音效的保存路径\n\n{o}它必须是WAV格式的文件，不过请不要输入这个后缀。{w}\n\n路径是建立于\\World of Warcraft\\根目录之上的。\n\n{v}请按下Enter来预览音效。";
	TRP2_LOC_SoundURLExtern = "添加外来音效";
	TRP2_LOC_Distance = "距离";
	TRP2_LOC_DistanceTT = "这是本地音效播放时，以码为单位的传播距离。";
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	-- Divers tooltips
	-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
	TRP2_LOC_TAILLE_TT = "这是人物的身高， {v}相对其种族的平均身高而言{o}. 比方说，如果你说你的暗夜精灵很高, 这就意味着他比大多数暗夜精灵高。";
	TRP2_LOC_SILHOUETTE_TT = "这是人物的大致提醒(请联想BMI指数)。一身肥肉还是鼓鼓的二头肌？请在这里决定。";
	TRP2_LOC_PHYSIQUE_TT = "这是人物的描述。人物描述详细建议请见使用指南。";
	TRP2_LOC_ACTUJ_TT = "这是人物当前的重要信息。\n这些信息会显示在人物的鼠标提示框中，所以，请尽量简短。{o}."
							.." 请局限于与其他玩家有关的信息。再者，请不要忘记，这些信息只在短时间内有关。永久的信息可以填写在人物描述页面中。";
	TRP2_LOC_NOTES_TT = "你可以为人物写下注释。{v}这些注释会显示在人物鼠标提示框中。";
	TRP2_LOC_CHERCHER_TT = "搜索规范:\n%1";
	TRP2_LOC_CRIT_NOMPET = "{v} - 小伙伴的原名\n - 小伙伴的TRP2名称";
	TRP2_LOC_CRIT_NOM = "{v} - 人物的原名\n - 姓氏\n - 名字\n - 称号";
	TRP2_LOC_PETNAME_TT = "小伙伴的名字";
	TRP2_LOC_PETPHYS_TT = "这是你的小伙伴的描述。可以描述它的外表或者行为。该描述将显示在小伙伴的鼠标提示框中。"
								.." 请尽量{v}保持简短，只写下重要的信息。";
	TRP2_LOC_PETHIST_TT = "这是小伙伴背景故事的概要。请描述重要的事件。它的完整背景故事可以放在论坛上，或者分开放在概要之后。";
	TRP2_LOC_ACCESS_TT = "只显示特定信任值以上的人物";
	TRP2_LOC_REL_TT = "只显示特定关系的人物";
	
	TRP2_LOC_RELACCES_TT = "\n\n{v}关系:\n{o}决定该人物与你的人物之间关系的类型。这并不一定是双方的。\n\n"
								.."{v}信任值:\n{o}决定你对该玩家的信任度。根据你的设定，信任值将决定该玩家能从你这里获取多少信息，和二人之间的TRP2如何沟通。\n";
	TRP2_LOC_COPYNAME = "复制目标的名称";
	TRP2_LOC_AFFICHERTOUT = "显示全部";
	TRP2_LOC_AFFICHERTOUTTT = "显示全部的坐骑和小伙伴，无论是否有自定义信息。";
	TRP2_LOC_DATABASECHECK = "显示Total RP 2自定义内容";
	TRP2_LOC_EFFETPAROLETT = "这是人物将会说的文字。\n\n{v}提示:{o}\n- 以 {v}||{o} 开始的文字将显示为叙述。\n"
								.."- {j}\"|| 人物名称 说: 文字\"{o} 将模拟此人的对话。";
	TRP2_LOC_DURABILITYSAC_TT = "这是你的背包的状况。损坏越严重，丢失物品或金钱的风险也越大……";
	TRP2_LOC_DURABILITYCOFFRE_TT = "这是你的箱子的状况。损坏越严重，丢失物品或金钱的风险也越大……";
	TRP2_LOC_POIDSCOFFRE_TT = "这是你的箱子当前的重量。";
	TRP2_LOC_CREAOBJETNOM = "这是物品的名称。注意：两个物品可以有同样的名称。(此栏为必填。)";
	TRP2_LOC_CREAOBJETDESCR = "这是该物品的描述。(此栏为必填。)";
	TRP2_LOC_CREAOBJETCATE = "这是该物品的分类 (配料，食物，etc)。这是单纯的信息，不影响实际效果。";
	TRP2_LOC_CREAOBJETUNIQUE = "这是人物可以同时拥有该物品的最大数量(不论物品储藏在哪里)。 {v}0意味着无限。";
	TRP2_LOC_CREAOBJETPOIDS = "这是每个单位的净重 (克)。该重量会影响人物的体力，也会影响包裹破旧时被撑破的可能性。";
	TRP2_LOC_CREAOBJETLIFETIME = "这是该物品的寿命 (秒)。从物品加入物品栏时开始倒计时，倒计时到达0时物品将会消失(并触发{j}寿命结束时{o}事件)。 {v}0意味着无限寿命。";
	TRP2_LOC_CREAOBJETVALEUR = "这是该物品每个单位的价值 (铜币)。";
	TRP2_LOC_CREAOBJETICONE = "这是物品的图标\n\n{j}点击:{w} 选择图标";
	TRP2_LOC_CREAOBJETSTACK = "这是该物品在同一物品栏中的最大堆叠数量。\n\n{j}注意: 可使用物品中，带有1个以上消耗次数，或有固定寿命的物品，无法被堆叠。";
	TRP2_LOC_CREAOBJETQUALITY = "决定物品的质量，于是也决定物品名称的颜色。";
	TRP2_LOC_CREAOBJETCHARGES = "决定在物品加入物品栏后，默认的可消耗次数。每次成功使用后，该物品将失去1点消耗次数。"
										.."在消耗用光时，该物品将消失 (并触发{j}耗尽时{o}事件)。";
	TRP2_LOC_CREAOBJETACTNAME = "请在这里表明使用时的具体动作。它会以绿色文字出现在鼠标提示框中，紧接着{v}\"使用: \"{o}。";
	TRP2_LOC_RECHARGE_TT = "这是该物品的默认冷却时间。{j}冷却时间会影响相同种类的全部物品。\n{o}冷却结束时，会触发{j}冷却结束时{o}事件。";
	TRP2_LOC_DUREETEXT_TT = "决定使用该物品所需的时间，就像物品的施法条。 {v}0代表可瞬间使用。\n\n{j}如果物品有使用时间的话，"
								.."使用时间开始时将触发{v}使用时(start){j}事件。使用时间结束时，将触发{v}使用时(end){j}事件。"
								.."如设为瞬间使用，将直接触发{v}使用时(end){j}事件。";
	TRP2_LOC_ANIMATION_TT = "{j}如该物品拥使用时间，{o}此栏决定要在使用时播放的动画所对应的数字。";
	TRP2_LOC_ACTIONTEXT_TT = "{j}如该物品有使用时间，{o}此栏决定施法条上显示的名称。";
	TRP2_LOC_STOLABLETT = "决定使用物品时，人物是否需要站在原地不动。如果该物品有使用时间的话，中途移动会打断使用。";
	TRP2_LOC_USABLETT = "决定该物品能否被使用。如设为可用，将解锁下方一系列选项和{j}使用时(end){o}触发项";
	TRP2_LOC_GIVABLETT = "决定该物品是否能在人物之间相互交易。{v}(请联想\"物品绑定\"){o}。如果该物品被交易，将在交易时触发{j}交易时{o}事件 (仅对赠物者有效)。";
	TRP2_LOC_DESTROYABLETT = "决定该物品是否可以被玩家手都丢弃。丢弃物品时，将触发{j}销毁时{o}事件。";
	TRP2_LOC_MANUALTT = "决定该物品是否可以手动添加到人物的物品栏中。";
	TRP2_LOC_DEC_OBJ_RECEIVE = "事件于人物得到物品时触发，不论他是如何得到该物品的 (交易、状态、或者手动)。"
									.." 如果同时收到多个堆叠在一起的物品，只会触发事件一次。\n\n";
	TRP2_LOC_DEC_OBJ_DESTROY = "事件于物品丢失时触发，这包括：\n- 被手动丢弃\n-"
									.." 被其它物品销毁\n- 被赠予其它玩家\n\n";
	TRP2_LOC_DEC_OBJ_USESTART = "事件于带有使用时间的物品开始使用时触发。"
									.."\n{j}如果此事件带有条件，{v}使用失败 (start){j}事件将被解锁。\n\n";
	TRP2_LOC_DEC_OBJ_USEFIN = "事件于物品使用成功后触发 (包括瞬间使用)。"
									.."\n{j}如果此事件带有条件，{v}使用失败 (end){j}事件将被解锁。\n\n";
	TRP2_LOC_DEC_OBJ_USESTARTFAIL = "事件于无法满足{j}使用时 (start){o}条件的情况下触发这允许了候补用途的存在。"
									.."\n{j}注意: 这意味着物品并没有真正被使用!{o}\n\n";
	TRP2_LOC_DEC_OBJ_USEFINFAIL = "事件于无法满足{j}使用时 (end){o}条件的情况下触发。 这允许了候补用途的存在。"
							.."\n{j}注意: 这意味着物品并没有真正被使用! 不会有任何消耗!{o}\n\n";
	TRP2_LOC_DEC_OBJ_DON = "事件于人物交易该物品时触发。该事件仅对赠物者有效，收物者只会受{j}接收时{o}事件影响。"
									.."\n\n";
	TRP2_LOC_DEC_OBJ_USED = "事件于物品全部耗尽并被销毁时触发。该事件可以和{j}使用时(end){o}事件同时触发，不过会覆盖{j}销毁时{o}事件。"
									.."\n\n";
	TRP2_LOC_DEC_OBJ_LIFETIME = "事件于物品达到寿命并被销毁时触发。将覆盖{j}销毁时{o}事件。\n\n";
	TRP2_LOC_DEC_OBJ_COOLDOWN = "事件于物品冷却结束时触发。"
									.."\n\n";
	TRP2_LOC_OUTILS = "工具";
	TRP2_LOC_NODISPOTRANS = "{r}该人物现在无法交易。";
	TRP2_LOC_PAGESUIV = "下一页";
	TRP2_LOC_PAGEPREC = "上一页";
	TRP2_LOC_QUESTOBJETTT = "将此物品添加到任务链中。它会在物品栏中发亮。";
	TRP2_LOC_WAITINGEXCHANGE = "{r}如果此消息总是显示，这说明你的交易对象目前无法交易。他可能在经历网络连接问题，或者禁用了TRP2。";
	TRP2_LOC_ERRORPLANQUE1 = "{r}{o}%1{r}的储藏地目前无法使用。";
	TRP2_LOC_AVERTDOCU1 = "{v}图片 n°%1\n\n{w}正在编辑的图片还未被保存。\n如果你不在执行此动作前保存该图片，{o}变动将全部丢失。\n\n{v}是否保存图片?";
	TRP2_LOC_AVERTDOCU2 = "{v}文字 n°%1\n\n{w}正在编辑的文字还未被保存。\n如果你不在执行此动作前保存该文字，{o}变动将全部消失。\n\n{v}是否保存文字?";
	TRP2_LOC_AVERTDOCU3 = "{v}页面 n°%1\n\n{w}正在编辑的页面还未被保存。\n如果你不在执行此动作前保存该页面，{o}变动将全部消失。\n\n{v}是否保存页面?";
	TRP2_LOC_AVERTDOCU4 = "{w}正在编辑的文件还未被保存。\n如果你不在执行此动作前保存该文件，{o}变动将全部消失。\n\n{v}是否保存文件?";
	TRP2_LOC_AVERTDOCU5 = "{o}警告!\n\n{w}生成该预览 (这包含此文件中的所有页面) 将会关闭所有编辑窗口 (页面，图片，文字)。未保存的变动将会丢失。\n\n{v}是否生成预览?";
	TRP2_LOC_REPERES = "显示格尺";
	TRP2_LOC_NOMPLANQUE_TT = "这是你的储藏地的名称。\n请尽量让它贴切而简短。\n\n比方说:\n{j}- 小土丘\n- 木箱\n- 信箱，\nect.";
	TRP2_LOC_PersonnagePerm_TT = "这是允许使用你的储藏地的人物列表。\n请用英文逗号(,)来分隔他们的名字。\n\n{j}如果你将这里留空，任何达到指定信任值的人物便都可以使用你的储藏地。";
	TRP2_LOC_PlanqueAcces_TT = "这是使用此储藏地所需的最低信任值。\n\n{j}这将与上方的人物列表同时生效。";
	TRP2_LOC_PLANQUEINTER = "储藏地无法被两个人物同时使用。\n\n{v}%1{w}已经在使用这个储藏地。是否驱逐他，让自己的人物使用该储藏地?";
	TRP2_LOC_AJOUTETAPE = "新增步骤";
	TRP2_LOC_AJOUTACTION = "新增动作";
	TRP2_LOC_ETAPENUM = "这是该步骤的ID。你无法创建两个ID相同的步骤。\n\n{j}ID并不一定是数字，虽然使用数字会让管理过程方便一些。\n\n{v}如任务被手动添加到任务日志中，它总会从1步骤开始。";
	TRP2_LOC_ETAPEDESCR = "请在这里写下该步骤的概括。它将显示在任务日志中，提醒玩家当前步骤中所发生的事件，和下个步骤的目标。";
	TRP2_LOC_STATEQUEST = "决定该步骤是否会造成任务的成功或失败。\n\n{j}你可以让多数步骤造成成功，这样你的任务就可以有多种结尾了!";
	TRP2_LOC_ONETAPETT = "事件于达成此步骤时触发。\n\n";
	TRP2_LOC_ONACTIONTT = "事件于执行此动作时触发。\n\n";
	TRP2_LOC_ACTIONTYPETT = "决定动作的形式:\n\n{j}搜查:\n"
									.."{o}你的人物搜查四周或特定的目标。"
									.."\n{v}该动作由/search表情，或快捷方式条中的搜索按钮触发。\n\n{j}听:\n"
									.."{o}你的人物聆听四周或特定目标。"
									.."\n{v}该动作由/listen表情，或快捷方式条中的听按钮触发。\n\n{j}看:\n"
									.."{o}你的人物观察四周或特定目标。"
									.."\n{v}该动作由/look表情，或快捷方式条中的看按钮触发。\n\n{j}说话:\n"
									.."{o}你的人物开始说话。对话不一定有目标 (比如说咒语之类的)。"
									.."\n{v}该动作由人物的说话或大喊触发。";
	TRP2_LOC_ACTIONETAPES = "这是可以执行动作的步骤。\n\n{j}请用英文逗号(,)分隔步骤名称。如将这里留为空，便可以在任何步骤中使用该动作。";
	TRP2_LOC_ACTIONPAROLES = "{j}当执行\"说话\"一类的动作时，此文字会触发动作。";
	TRP2_LOC_TITREDOCTT = "这是文件的标题。它将会显示在页面顶端。";
	TRP2_LOC_ICODOCU = "这是文件的图标。它将会显示在页面左上角。";
	TRP2_LOC_DOCUAPER = "这会显示完整的文件。请不要忘记，要事先保存好全部页面。\n\n{j}显示预览并不会保存文件!";
	TRP2_LOC_AJOUTPAGE = "新增页面";
	TRP2_LOC_AJOUTPAGETT = "添加新的页面。\n\n{j}警告: 这个页面只有在被保存后，才会出现在文件和页面列表中。";
	TRP2_LOC_SAVEPAGETT = "在文件中保存页面。\n\n{j}警告: 如果你编辑了本页面上的要素，请在保页面前，事先保存该要素!";
	TRP2_LOC_CANCELPAGETT = "取消页面上的所有改动，并关闭此页面。";
	TRP2_LOC_TEXTEPAGETT = "这是页面上的主文字。可以通过{j}版式tag{o}来排版 {v}(详情请见使用手册)。\n\n{o}主文字永远会位于其他要素之上。";
	TRP2_LOC_AJOUTELEM = "添加要素";
	TRP2_LOC_AJOUTELEMTT = "在页面上添加新的要素。\n\n{j}警告: 这个要素只有在被保存后，才会出现在文件和要素列表中。\n\n{j}"
								..TRP2_LOC_CLIC.." : {w}添加图片\n{j}"..TRP2_LOC_CLICDROIT.." : {w}添加文字";
	TRP2_LOC_LEVELTT = "要素的等级决定他们显示顺序，也就是哪个要素会显示在其他要素上面。"
						.." 共有五个等级：1是最低的 (离你最\"远\"的"
						.."，而5则是最高的。\n\n{j}比方说，等级1的图片会被压在等级2图片的下面。\n\n"
						.."{o}这只会影响到同类要素的重叠模式 (图片或文字)。等级相同的情况下，文字总会出现在图片上方。\n\n{r}警告: {j}如果两个同类的要素被设为了相同的等级，系统将随机把其中一个放在前面! 你应该避免这种情况，得当的使用已有的5个等级。";
	TRP2_LOC_URLTT = "填写质感的保存路径，以WoW安装路径为基础。\n"
							.."此路径并不区分大小写。\n\n{j}你可以使用自定义质感，不过它们必须也事先 (游戏加载前)放在游戏安装路径里。";
	TRP2_LOC_HeigthTT = "图片高度（像素）。";
	TRP2_LOC_WidthTT = "图片宽度（像素）。";
	TRP2_LOC_PAR_ICOTARPOSXTT = "要素的水平位置 (像素)，以中央为起点 (0,0)。";
	TRP2_LOC_PAR_ICOTARPOSYTT = "要素的垂直位置 (像素)，以中央为起点 (0,0)。";
	TRP2_LOC_PAR_ROGNERTT = "剪裁图片，只显示一部分质感。\n百分比格式。\n\n{j}详情请见使用手册。";
	TRP2_LOC_PAR_ROUNDEDTT = "将图片圆化。这并不实用于所有质感。如果质感并不兼容，可能会导致画面Bug，或者直接不出现。";
	TRP2_LOC_DesaturerTT = "去除图片的颜色，只显示各种灰色。";
	TRP2_LOC_ALIGNEMENTTT = "决定两种颜色渐变的方向。当然了，这两个颜色必须不一样，你才能看到渐变。";
	TRP2_LOC_Couleur1TT = "质感的第1个颜色。如果使用水平渐变，它将会出现在左侧。如果是垂直渐变，它会在下方。"
								.."\n\n{j}单击{w}: 改变颜色\n{j}Ctrl+单击{w}: 与第2个颜色调换。\n{j}Shift+单击{w}: 复制第2个颜色。\n{j}右键{w}: 重设颜色。";
	TRP2_LOC_Couleur2TT = "质感的第2个颜色。如果使用水平渐变，它将会出现在右侧。如果是垂直渐变，它会在上方。"
								.."\n\n{j}单击{w}: 改变颜色\n{j}Ctrl+单击{w}: 与第1个颜色调换。\n{j}Shift+单击{w}: 复制第1个颜色。\n{j}右键{w}: 重设颜色。";
	TRP2_LOC_CADRELARGTT = "决定文本框的宽度 (像素). 文本框决定文字的对其位置。";
	TRP2_LOC_CADREHAUTTT = "决定文本框的高度 (像素). 文本框决定文字的对其位置。";
	TRP2_LOC_FONT_SIZE = "决定字体的大小。";
	TRP2_LOC_ESPACETT = "决定文字行与行之间的间距 (像素)。";
	TRP2_LOC_FONTTT = "决定文字的字体。";
	TRP2_LOC_ALIGNEMENTVTT = "同时决定文字在文本框中的垂直对其位置，和文本框在页面中的垂直对其位置。";
	TRP2_LOC_ALIGNEMENTHTT = "同时决定文字在文本框中的水平对其位置，和文本框在页面中的水平对其位置。";
	TRP2_LOC_PAR_ICOTARPOSShadX = "决定阴影的水平位置。";
	TRP2_LOC_PAR_ICOTARPOSShadY = "决定阴影的垂直位置。";
	TRP2_LOC_CouleurTT = "决定文字的默认颜色。\n\n{j}单击{w}: 改变颜色\n{j}右键{w}: 重设颜色";
	TRP2_LOC_OmbreTT = "决定文字的投影颜色\n\n{j}单击{w}: 改变颜色\n{j}右键{w}: 重设颜色";
	TRP2_LOC_ContoursTT = "为文字添加边框效果。";
	TRP2_LOC_REINITTT = "决定任务是否可以无限重设，比如说在失败时重来，或者在成功后重做。";
	TRP2_LOC_MANUALQUESTTT = "决定玩家是否手动将任务添加到任务日志中。";
	TRP2_LOC_QUESTTITRETT = "任务的标题，会显示在任务日志中。";
	TRP2_LOC_DescriptionQUEST = "这是任务的描述。它会简单的预告一下任务是什么。\n\n{j}可以在这里提一下任务的前提。";
	TRP2_LOC_MAITRISE = "流利度";
	TRP2_LOC_DIALCHOOSE = "选择方言";
	TRP2_LOC_DocuCHOOSE = "选择文件";
	TRP2_LOC_OBJCHOOSE = "选择物品";
	TRP2_LOC_QUESTCHOOSE = "选择任务";
	TRP2_LOC_AURACHOOSE = "选择状态";
	TRP2_LOC_ADDMETHODE = "添加方式";
	TRP2_LOC_ADDLANG = "是否将{v}%1{w}加入你的方言列表?";
	TRP2_LOC_ADDMETHODEQUEST_TT = "标明如果人物的方言列表中没有该方言时，会发生什么。\n\n"
										.."可以选择什么也不发生、提示他添加方言、或者自动添加方言。";
	TRP2_LOC_MAITRISETT = "标明对该方言流利度的改变。比如说，\"15\"会 {v}增加{o}15点流利度 (上限为100)。"
								.." \"-30\"会{v}降低{o}30点流利度 (下限为0)。";
	TRP2_LOC_TEXTDISPLAY_TT = "决定文字的显示方式。";
	TRP2_LOC_MONTANTTT = "根据设定，会从背包中添加或移除的铜币数量";
	TRP2_LOC_MODEORTT = "决定是从背包中添加还是移除上述铜币数量。";
	TRP2_LOC_DUREEAURA_TT = "状态的持续时间 (秒)。(当状态被添加时。)";
	TRP2_LOC_TARGETTT = "决定执行动作的目标。";
	TRP2_LOC_MODEAURATT = "决定是要在目标身上添加还是移除状态。";
	TRP2_LOC_QUANTITEOBJ_TT = "在背包添加/移除的单位数量。";
	TRP2_LOC_MODEOBJTT = "决定是要添加还是移除单位。";
	TRP2_LOC_DUREETIMETT = "物品的持续时间。\n{v}0将取消进行中的持续时间。\n\n{j}提醒: 当物品寿命结束时，物品会被销毁。这会触发\"寿命结束时\"事件。";
	TRP2_LOC_DUREECOOL = "物品种类的冷却时间。";
	TRP2_LOC_URLSONTT = "音效文件的保存路径 (以WoW跟目录为基础). 你可以输入多个音效，用换行分隔它们: 播放时会随机选择一个。";
	
	TRP2_LOC_PORTESONTT = "本地音效的范围，以坐标为单位 (+= 2码)。"
	TRP2_LOC_URLSONMODETT = "音效播放的模式:\n{j}个人: {o}只有玩家自己能听到。\n{j}本地: {o}播放范围内的全部玩家。\n"
									.."{j}全局 (Raid和队伍): {o}整个队伍。";
	TRP2_LOC_MONTANTDGTSAC = "要从背包或箱子上增加/减少的HP。";
	TRP2_LOC_DEGATYPE = "决定是要添加还是减少背包或箱子的HP。";
	TRP2_LOC_DEGATCIBLE = "决定动作的目标是背包还是箱子。";
	TRP2_LOC_MODEQUESTS = "标明如果任务日志中没有该任务，会发生什么。\n\n"
								.."可以选择什么也不发生、提示他添加任务、或者自动添加任务。";
	TRP2_LOC_ETAPEIDTT = "这是任务会到达的步骤的ID。";
	TRP2_LOC_STARTQUEST2 = "将任务添加到任务日志";
	TRP2_LOC_STARTDIAL = "学习新的方言";
	TRP2_LOC_PLAY = "播放";
	TRP2_LOC_PLAYTT = "将以表情的形式显示文字。";
	TRP2_LOC_INVERROR1 = "你仅能在背包与储藏地之间移动物品。";
	TRP2_LOC_INVERROR2 = "你仅能使用背包中的物品。";
	TRP2_LOC_INVERROR3 = "你无法在进行交易时移动背包中的物品。";
	TRP2_LOC_TARGETTAKE = "说话或做表情的人物的名称。你可以使用左边的按钮来复制当前目标的名称。";
	TRP2_LOC_TEXTEANIMTT = "要说/播放的文字。\n\n请按Enter键来确认并执行。";
	TRP2_LOC_REGDELALLTT = "删除"..TRP2_Royaume.."上的全部人物信息。";
	TRP2_LOC_EPURER = "清空通讯薄";
	TRP2_LOC_EPURERTT = "删除从未遇见过的人物信息";
	TRP2_LOC_QUESTDISPLAY = "过滤任务列表";
	TRP2_LOC_QUESTSTATE = {};
	TRP2_LOC_QUESTSTATE[1] = "当前任务";
	TRP2_LOC_QUESTSTATE[2] = "失败的任务";
	TRP2_LOC_QUESTSTATE[3] = "成功的任务";
	TRP2_LOC_QUESTSTATE[4] = "全部任务";
	TRP2_LOC_AfficherCacher = "显示/隐藏";
	TRP2_LOC_CLICGLISSER = "拖动";
	TRP2_LOC_MODIF = "更改";
	TRP2_LOC_ACCROFON = "兼容性";
	TRP2_LOC_ANIMSELECT = "选择动画";
	TRP2_LOC_OTHERCREA = "显示他人创建的自定义内容";
	TRP2_LOC_NEWVERSION = "{v}又新版本的Total RP 2了!\n\n{j}你的版本: %2\n{j}最新版本: %1\n\n"
								.."{o}快去更新吧!\n{v}http://forums.telkostrasz.be/\n\n{o}此信息只会显示一次，可以在设定 (常规) 中关闭。";
	TRP2_LOC_CREACOLIS = "创建包裹";
	TRP2_LOC_Destinataire = "收件人";
	TRP2_LOC_Message = "信息";
	TRP2_LOC_ChoixMasc = "选择小伙伴/坐骑";
	TRP2_LOC_MascotteNomTT = "这是人物要召唤的小伙伴/坐骑的名称。\n要用它们的WoW名称。\n{j}请注意拼写 (区分大小写...).";
	TRP2_LOC_TITREGUIDE = "Total RP 2 使用手册";
	TRP2_LOC_PAR_ChannelToUseNomTT = "这是TRP2广播频道的名称。";
	TRP2_LOC_CloseCombatTT = "如果选择了这个选择，将在战斗中自动关闭所有TRP2窗口。\n\n{r}不过要小心: 这也会关闭自定义内容创建页面，不会保存变动!";
	TRP2_LOC_NotifyTT = "在遇到有更新版本TRP2的玩家时提示你。此提示每次游戏时只会显示一次。";
	TRP2_LOC_PAR_PORXTT = "设置肖像按钮的水平位置。";
	TRP2_LOC_PAR_PORYTT = "设置肖像按钮的垂直位置。";
	TRP2_LOC_PAR_PORFRameTT = "这是肖像按钮的停靠窗框。默认为目标窗框 (TargetFrame)。";
	TRP2_LOC_PAR_ETAXTT = "设置状态窗口的水平位置";
	TRP2_LOC_PAR_ETAYTT = "设置状态窗口的垂直位置。";
	TRP2_LOC_PAR_ETAFRameTT = "这是状态窗口的停靠位置。默认为目标窗框 (TargetFrame)。";
	TRP2_LOC_RACCAFFTT = "在进入游戏时隐藏/显示快捷方式条。";
	TRP2_LOC_AlphaRaccBarTT = "快捷方式条透明度.";
	TRP2_LOC_HRPMODETT = "允许TRP2探测出OOC对话 (括号中的文字)。当发现OOC文字时，你可以选择让它用特殊颜色显示，或者出现在另一个聊天窗口中。";
	TRP2_LOC_PAR_BALIICO = "显示图标Tag";
	TRP2_LOC_PAR_BALIICOTT = "在对话中显示/隐藏图标Tag。";
	TRP2_LOC_EMOTEMODETT = "允许TRP2在对话中探测出表情 (带有<>或**的文字)。\n\n{j}表情颜色 :{o}\n你的原本聊天设定中，NPC的表情颜色。\n\n{j}表情编辑 :{o}\n除了改变表情的颜色，TRP2会在/say和/yell中探测表情，并将它们转换成普通的/e表情。仅对**中的表情有效。";
	TRP2_LOC_PNJMODETT = "自动排版NPC对话。";
	TRP2_LOC_PAR_DefautAccesTT = "决定通讯薄中的人物的默认信任值。\n\n{r}不建议设为 \"最大\"，因为这会禁用TRP2一切的安全功能。";
	TRP2_LOC_PAR_NotifyNewTT = "当新人物被添加到你的通讯薄中时，显示提示信息。Get a warning message whenever a character is added to the Directory.";
	TRP2_LOC_PAR_AutoNewTT = "允许TRP2自动将人物添加到你的通讯薄中。";
	TRP2_LOC_PAR_CompatibFlagRSPTT = "允许收集FlagRSP插件用户的名称、称号等信息。\n\n{j}警告: 那些玩家并不能看到你的信息。";
	TRP2_LOC_PAR_DefautHisto = "人物故事信任值";
	TRP2_LOC_PAR_DefautHistoTT = "只有达到该信任值的人才能看到你的人物故事。";
	TRP2_LOC_PAR_HideOT = "隐藏系统鼠标提示框";
	TRP2_LOC_PAR_HideOT_TT = "隐藏暴雪的原版人物鼠标提示框。\n\n如果你安装了其他改变鼠标提示框的插件的话 (Gearscore之类的)，你也许应该禁用这个选项。";
	TRP2_LOC_PAR_NomReduit = "缩短名称";
	TRP2_LOC_PAR_NomReduitTT = "不显示称号。";
	TRP2_LOC_ENABLE_SOUNDTT = "开启TRP2音效。\n\n注意: 开启了WoW音效才能听到TRP2音效。";
	TRP2_LOC_GlobSoundAccesTT = "设置听到其他玩家的音效的信任值。";
	TRP2_LOC_MINIMAPOK = "在地图上显示";
	TRP2_LOC_MINIMAPOKTT = "在其他玩家的区域地图上显示。";
	TRP2_LOC_AFFICHERGENS = "人物";
	TRP2_LOC_AFFICHERGENSTT = "更新该地区内TRP人物位置。";
	TRP2_LOC_AFFICHERPL = "显示储藏地";
	TRP2_LOC_AFFICHERPLTT = "在地图上显示该地区内的储藏地。";
	TRP2_LOC_CREAPACK = "导入包裹";
	TRP2_LOC_EXPORTALERT = "{v}导出\n\n{w}TRP2将制作一个包含你的自定义内容的包裹。在这个过程中，游戏UI会重新加载。不用担心，这是完全正常的！ "
								.."这么做是为了将数据强制导出至你的硬盘。当界面重载完毕后，你会得到进一步的指示。\n\n{v}开始导出?";
	TRP2_LOC_EXPORTWIN = "{v}导出\n\n{w}Total RP 2 已成功导出你的自定义内容包! 你可以在这个位置找到它:\n\n{j}\\World of Warcraft\\WTF\\Account\n\\你的账号\\SavedVariables\\\ntotalRP2_ImpExport.lua"
								.."\n\n{w}你可以随意重命名或者移动它。如果想与朋友分享，把这个文件E-mail给他们就行! 这样他们便可以进行导入了。\n\n\n"
	TRP2_LOC_EXPORT = "添加至导出包裹";
	TRP2_LOC_IMPORTALERT = "{v}导入\n\n{w}TRP2将导入此包裹中的全部内容，只要你目前并没有它们。";
	TRP2_LOC_URLCLIC = "这是链接URL:\n\n%1\n\n请将它黏贴到网络浏览器中。\n\n{r}声明! {w}Total RP 2 不对此链接内容负责。"
	TRP2_LOC_NODIAL = "无对话效果";
	TRP2_LOC_NODIALTT = "自动将对话效果转化成个人文字效果。";
	TRP2_LOC_Observer_TAR_TT = "看向%1。";
	TRP2_LOC_Ecouter_TAR_TT = "聆听%1。";
	TRP2_LOC_Fouiller_TAR_TT = "搜查%1。";
	TRP2_LOC_Dire_TAR_TT = "与%1说话。";
	TRP2_LOC_REPERT = "通讯薄";
	TRP2_LOC_Observer_ENV_TT = "四下看看。";
	TRP2_LOC_Ecouter_ENV_TT = "四下聆听。";
	TRP2_LOC_Fouiller_ENV_TT = "搜查附近";
	TRP2_LOC_Achnor_Chat = "禁用聊天功能";
	TRP2_LOC_VerrError = "This creation is read-locked.";
	TRP2_LOC_Achnor_ChatTT = "禁用一切与聊天窗口有关的TRP2功能： "
									.." 这包括对OOC、表情、和NPC对话的探测，还有对话的翻译。"
									.."\n\n{j}如与其他使用聊天窗口的插件遇到兼容问题，请禁用这个功能。"
									.."\n\n{r}重载界面后，变动才会生效 (/reload)。";
	TRP2_LOC_Achnor_Paroles = "禁用语言功能";
	TRP2_LOC_Achnor_ParolesTT = "禁用所有人物聊天中的TRP2功能：方言，对话Tag，\"Say\" 任务选项, etc."
									.."\n\n{j}如与其他使用聊天窗口的插件遇到兼容问题，请禁用这个功能。"
									.."\n\n{r}重载界面后，变动才会生效 (/reload)。";
	TRP2_LOC_Achnor_Emote = "禁用表情功能";
	TRP2_LOC_Achnor_EmoteTT = "禁用任务中的表情探测功能。"
									.."\n\n{j}如与其他使用表情系统的插件遇到兼容问题，请禁用这个功能。"
									.."\n\n{r}载界面后，变动才会生效 (/reload)。";
	TRP2_LOC_Achnor_ItemRef = "禁用姓名点击功能";
	TRP2_LOC_Achnor_ItemRefTT = "禁用聊天窗口中的ctrl+右键 点击功能。"
									.."\n\n{j}如与其他使用类似功能的插件遇到兼容问题，请禁用这个功能。"
									.."\n\n{r}载界面后，变动才会生效 (/reload)。";
	TRP2_LOC_ErreurGen_1 = "{r}数据[%2]过大，无法发送给%1";
	TRP2_LOC_ErreurGen_2 = "语构错误";
	TRP2_LOC_Link = "链接";
	TRP2_LOC_Nord = "北";
	TRP2_LOC_NordOuest = "西北";
	TRP2_LOC_Ouest = "西";
	TRP2_LOC_SudOuest = "西南";
	TRP2_LOC_Sud = "南";
	TRP2_LOC_SudEst = "东南";
	TRP2_LOC_Est = "东";
	TRP2_LOC_NordEst = "东北";
	TRP2_LOC_SoudPlayeedBy = "{j}音效播放者：{v}[|Hplayer:%1|h%1|h]{j} (队伍-raid):\n{c}%2";
	TRP2_LOC_GlSoudPlayeedBy = "{j}音效播放者：{v}[|Hplayer:%1|h%1|h]{j} (全局):\n{c}%2";
	TRP2_LOC_LocSoudPlayeedBy = "{j}音效播放者：{v}[|Hplayer:%1|h%1|h]{j} (本地):\n{c}%2";
	
	-- Suite !
	TRP2_LOC_PAR_CutAfterX = "在 %1 字节后剪裁。";
	TRP2_LOC_PAR_NoCut = "不要剪裁。";
	TRP2_LOC_PAR_ShowIcone = "显示图标";
	TRP2_LOC_PAR_ShowRelIcone = "显示关系图标";
	TRP2_LOC_PAR_SmallNames = "缩短名称";
	TRP2_LOC_PAR_ShowAllTitle = "显示完整称号";
	TRP2_LOC_PAR_ShowCRN = "显示职业，种族，和等级";
	TRP2_LOC_PAR_ShowRealm = "显示服务器";
	TRP2_LOC_PAR_ShowGuild = "显示公会详情";
	TRP2_LOC_PAR_ShowActuinfo = "显示当前信息";
	TRP2_LOC_PAR_ShowEtats = "显示状态";
	TRP2_LOC_PAR_ShowNotes = "显示注释";
	TRP2_LOC_PAR_ShowValue = "显示数值";
	TRP2_LOC_PAR_ShowWeight = "显示重量";
	TRP2_LOC_PAR_ShowObjHelp = "显示帮助";
	TRP2_LOC_PackCreation = "创建包裹";
	TRP2_LOC_PackOneCrea = "{w}1个自定义物品";
	TRP2_LOC_PackMultiCrea = "{w}%1个自定义物品";
	TRP2_LOC_PackEmpty = "清空包裹";
	TRP2_LOC_PackRemoveFrom = "移除包裹";
	TRP2_LOC_CreationType = "自定义内容种类";
	TRP2_LOC_CreationTypeObjet = "物品";
	TRP2_LOC_CreationTypeDoc = "文件";
	TRP2_LOC_CreationTypeEtat = "状态";
	TRP2_LOC_CreationTypeQuest = "任务";
	TRP2_LOC_CreationTypeLang = "方言";
	TRP2_LOC_MAITRISE = "流利度";
	TRP2_LOC_NOARG = "此效果无引数";
	TRP2_LOC_EFFETNUM = "效果数量";
	TRP2_LOC_EVENTEDIT = "编辑事件";
	TRP2_LOC_EVENTREINIT = "重设事件";
	TRP2_LOC_NOEDITEFFET = "效果无法编辑。";
	TRP2_LOC_EDITEFFET = "编辑效果";
	TRP2_LOC_DELETEEFFET = "移除效果";
	TRP2_LOC_MoveUp = "向上移动";
	TRP2_LOC_MoveDown = "向下移动";
	TRP2_LOC_CONDITESTE = "已测验条件";
	TRP2_LOC_CONDIEDIT = "编辑条件";
	TRP2_LOC_CONDIDELETE = "移除条件";
	TRP2_LOC_GOTOAND = "切换为{v}和(^)逻辑";
	TRP2_LOC_GOTOOR = "切换为{v}或(v)逻辑";
	TRP2_LOC_ANOTHERCREAERROR = "这是未知数值。它可能来自于新版的TRP2。";
	TRP2_LOC_ANOTHERCREAERROR2 = "这是未知comparison。它可能来自于新版的TRP2。";
	TRP2_LOC_NUMCONDI = "条件数值";
	TRP2_LOC_CONDI = "条件";
	TRP2_LOC_ExporteError1 = "你无法导出数据库中的自定义内容。";
	TRP2_LOC_ExporteError2 = "此自定义内容已在导出包中。";
	TRP2_LOC_ImportMess1 = "{j}自定义内容{v}%1{j}已成功导入。";
	TRP2_LOC_ImportMess2 = "{v}导入\n\n{w}%1个自定义内容。";
	TRP2_LOC_ImportMess3 = "导入包裹";
	TRP2_LOC_Import = "导入";
	TRP2_LOC_NoDoc = "无\n文件";
	TRP2_LOC_ImportMess4 = "你已经有最新版本了。";
	TRP2_LOC_ImportMess5 = "导入自定义内容";
	TRP2_LOC_GoldDelete = "{v}丢弃金钱\n\n{w}要丢弃多少枚铜币?";
	TRP2_LOC_PAR_NoYellingEmote = "无大喊表情";
	TRP2_LOC_PAR_NoYellingEmoteTT = "不显示大喊的表情";
	TRP2_LOC_PAR_TRPTT = "人物鼠标提示框";
	TRP2_LOC_PAR_TRPTTTT = "显示目标人物的增强版鼠标提示框。";
	TRP2_LOC_PAR_TRPTTMount = "坐骑鼠标提示框";
	TRP2_LOC_PAR_TRPTTMountTT = "显示带有目标坐骑信息的外加鼠标提示框。\n\n{o}必须先启用人物鼠标提示框。";
	TRP2_LOC_PAR_TRPTTInCombat = "在战斗中显示鼠标提示框";
	TRP2_LOC_PAR_TRPTTInCombatTT = "在战斗中也显示人物和坐骑鼠标提示框。";
	TRP2_LOC_NOMANUALAJOUT = "你无法手动添加这个物品。";
	TRP2_LOC_CREATIONSTAT = "{w}{o}%1的统计\n\n{w}实际传输大小: {o}%2{w}。\n也就是需发送 {o}%3 {w}条信息。";
	TRP2_LOC_CREATIONREF = "与其他自定义内容的关联";
	TRP2_LOC_CREATIONREF2 = "{o}%1 {w}被关联{o}%2 {w}次";
	TRP2_LOC_CREATIONREF3 = "{w}总相关大小: {o}%1{w}。\n也就是需发送 o}%2 {w}条信息。";
	TRP2_DOCUMENTAPERCU["Nom"] = "预览页面";
	TRP2_LOC_DOC_Font = "字体";
	TRP2_LOC_DOC_VALIGN = "垂直对齐。";
	TRP2_LOC_DOC_VALIGN1 = "上";
	TRP2_LOC_DOC_VALIGN2 = "中";
	TRP2_LOC_DOC_VALIGN3 = "下";
	TRP2_LOC_DOC_HALIGN = "水平对齐。";
	TRP2_LOC_DOC_HALIGN1 = "左";
	TRP2_LOC_DOC_HALIGN2 = "中";
	TRP2_LOC_DOC_HALIGN3 = "右";
	TRP2_LOC_DOC_DALIGN = "渐变对齐。";
	TRP2_LOC_DOC_EDITPAGE = "编辑页面 n°";
	TRP2_LOC_DOC_NOELEM = "无\n要素";
	TRP2_LOC_DOC_DELELEM = "删除要素%1 ?";
	TRP2_LOC_DOC_IMAGE = "图片";
	TRP2_LOC_DOC_IMAGEEDIT = "编辑图片";
	TRP2_LOC_DOC_IMAGEDEL = "删除图片";
	TRP2_LOC_DOC_IMAGECOPY = "复制图片";
	TRP2_LOC_DOC_TEXTE = "文字";
	TRP2_LOC_DOC_NOTEXTE = "无文字";
	TRP2_LOC_DOC_TEXTEEDIT = "编辑文字";
	TRP2_LOC_DOC_TEXTEDEL = "删除文字";
	TRP2_LOC_DOC_TEXTECOPY = "复制文字";
	TRP2_LOC_DOC_NOPAGE = "无\n页面";
	TRP2_LOC_DOC_PAGE = "页面";
	TRP2_LOC_DOC_PAGEAPER = "主文字预览";
	TRP2_LOC_DOC_PAGEEDIT = "编辑页面";
	TRP2_LOC_DOC_PAGEDEL = "删除页面";
	TRP2_LOC_DOC_PAGECOPY = "复制页面";
	TRP2_LOC_GUI_Table = "目录";
	TRP2_LOC_GUI_MErci = "鸣谢";
	TRP2_LOC_GUI_NoPage = "该页面不存在";
	TRP2_LOC_MAG_Boutik = "店铺";
	TRP2_LOC_MAG_BoutikVisit = "拜访店铺";
	TRP2_LOC_PEtMaster = "{w}%1{o}的小伙伴";
	TRP2_LOC_PEtMasterShow = "显示小伙伴卡";
	TRP2_LOC_NoPet = "无\n小伙伴";
	TRP2_LOC_UI_ListeObjet = "物品列表";
	TRP2_LOC_UI_NoObjet = "无\n物品";
	TRP2_LOC_UI_NoEtat = "无\n状态";
	TRP2_LOC_UI_ListeQuest = "任务列表";
	TRP2_LOC_DOC_EDIT = "编辑";
	TRP2_LOC_UI_ListeDocu = "文件列表";
	TRP2_LOC_UI_ListeDial = "方言列表";
	TRP2_LOC_UI_NoDial = "无\n方言";
	TRP2_LOC_UI_ListeSon = "音效列表";
	TRP2_LOC_UI_ListeValeur = "值列表";
	TRP2_LOC_UI_ListeEffet = "状态列表";
	TRP2_LOC_UI_DeleteColis = "是否获取包裹内容?";
	TRP2_LOC_UI_Delete2Colis = "丢弃包裹?";
	TRP2_LOC_UI_Select = "选择";
	TRP2_LOC_UI_Selected = "已选";
	TRP2_LOC_UI_BalTexte = "文本tag";
	TRP2_LOC_UI_BalCoul = "颜色tag";
	TRP2_LOC_UI_BalPage = "布局tag";
	TRP2_LOC_UI_JetDeDes = "投骰种类";
	TRP2_LOC_UI_JetDeDesGET = "得到了";
	TRP2_LOC_UI_SOUNDS = "音效";
	TRP2_LOC_INV_PLANQLOG1 = "{v}%1{w}移除了%2x %3{w}。";
	TRP2_LOC_INV_PLANQLOG2 = "{v}%1{w}添加了%2x %3{w}。";
	TRP2_LOC_INV_EXDel = "从交易中移除";
	TRP2_LOC_INV_CreatePile = "分成两摞";
	TRP2_LOC_INV_BuyOne = "紧购买一次";
	TRP2_LOC_INV_BuyMany = "购买多数";
	TRP2_LOC_GLISSERCTRL = "Ctrl+拖动";
	TRP2_LOC_INV_HIDERACC = "隐藏快捷方式";
	TRP2_LOC_IGN_ERROR = "该人物已被屏蔽";
	TRP2_LOC_NOTINREG = "此人物不在通讯薄中。";
	TRP2_LOC_NOTDELEX = "无法在进行交易时丢弃物品。";
	TRP2_LOC_SHOWCREALIST = "显示自定义内容列表";
	TRP2_LOC_INV_OUTILMAN = "缺少工具";
	TRP2_LOC_INV_COMPOMAN = "缺少配料";
	TRP2_LOC_INV_OBJUSEERROR2 = "物品无法这样使用。";
	TRP2_LOC_INV_EXSTART = "你正同%1发起交易。";
	TRP2_LOC_INV_COLISMADE = "{o}你创建了一个包裹。可以通过邮箱发送它。";
	TRP2_LOC_DB = "数据库";
	TRP2_LOC_OTHERS = "他人的自定义内容";
	TRP2_LOC_OTHERSTT = "显示他人创建的自定义内容。";
	TRP2_LOC_DBTT = "显示TRP2数据库中的自定义内容";
	TRP2_LOC_DESTI = "收件人";
	TRP2_LOC_SENDER = "发件人";
	TRP2_LOC_SENDCOLIS = "发送包裹";
	TRP2_LOC_GETCOLIS = "获取内容";
	TRP2_LOC_DELETECOLIS = "丢弃包裹";
	TRP2_LOC_SENDCOLISMESS = "{o}尝试向{v}%1{o}发送包裹。";
	TRP2_LOC_SENDCOLISOK = "{v}%1{o} 成功收到了你的包裹。";
	TRP2_LOC_rECEIVECOLIS = "{o}你收到了{v}%1{o}的包裹!";
	TRP2_LOC_CANTPLANQUEHERE = "你无法再这里创建储藏地。";
	TRP2_LOC_SLOTSUSED = "已使用位置";
	TRP2_LOC_USEDBY = "\n{r}被%1使用\n";
	TRP2_LOC_OWNER = "物主";
	TRP2_LOC_NOPLANQUE = "无\n储藏地";
	TRP2_LOC_NOPLANQUEHERE = "无\n储藏地\n被找到";
	TRP2_LOC_OPENPLANQUE = "使用储藏地";
	TRP2_LOC_YOUSPEAKNOW = "{j}你正在使用{o}[{v}%2{o}]{j}.";
	TRP2_LOC_FORGETLANG = "{j}%1忘记了{o}[{v}%2{o}]{j}。";
	TRP2_LOC_LEARNLANG = "{j}%1学会了{o}[{v}%2{o}]{j}，流利度为%3/100。";
	TRP2_LOC_DELLANG = "忘记方言";
	TRP2_LOC_CANTFORGET = "你无法忘记这个方言。";
	TRP2_LOC_SELECTLANG = "选择方言";
	TRP2_LOC_CHANGEMASTERY = "更改流利度";
	TRP2_LOC_CHANGEDMASTERY = "{j}你{o}[{v}%1{o}]{j}的流利度现在是%2/100.";
	TRP2_LOC_Traduction = "翻译";
	TRP2_LOC_unknownlang = "未知方言";
	TRP2_LOC_LEVEL = "等级";
	TRP2_LOC_SMOUNT = "{o}%1's的坐骑";
	TRP2_LOC_NODESCRI = "无\n描述";
	TRP2_LOC_NOHISTO = "无\n背景故事";
	TRP2_LOC_GOTORP = "IC模式";
	TRP2_LOC_GOTOHRP = "OOC模式";
	TRP2_LOC_ADDTOREGISTER = "将%1添加到通讯薄";
	TRP2_LOC_BL = "在TRP中屏蔽";
	TRP2_LOC_UNBL = "解除TRP中的屏蔽";
	TRP2_LOC_BLTT = "从此刻起，%1的互动将被屏蔽。";
	TRP2_LOC_UNBLTT = "%1的互动不再被屏蔽。";
	TRP2_LOC_UNMUTE = "开启声音";
	TRP2_LOC_MUTE = "静音";
	TRP2_LOC_UNMUTETT = "{o}%1的音效被开启了。";
	TRP2_LOC_MUTETT = "{o}%1的音效被静音了。";
	TRP2_LOC_OPENQUESTLOG = "打开任务日志";
	TRP2_LOC_CLOSEACTIONFRAME = "关闭 (无有效任务)";
	TRP2_LOC_QUESTFAILED = "{r}任务{o}%1{r}失败。";
	TRP2_LOC_QUESTCOMPLETZED = "{v}任务{o}%1{v}: 完成。";
	TRP2_LOC_STARTQUEST3 = "开始任务 %1?";
	TRP2_LOC_SPEAKWITH = "同%1说话";
	TRP2_LOC_AREA = "地区";
	TRP2_LOC_EDITACTION = "编辑动作";
	TRP2_LOC_COPYACTION = "复制动作";
	TRP2_LOC_EDITSTEP = "编辑步骤";
	TRP2_LOC_COPYSTEP = "复制步骤";
	TRP2_LOC_EDITPETFRAME = "{w}{o}%1{w}的小伙伴(编辑)";
	TRP2_LOC_PETLISTE = "小伙伴列表";
	TRP2_LOC_NOPETCHANGED = "无自定义小伙伴";
	TRP2_LOC_REA_COFFDAMAGE = "{j}你的箱子失去了{r}%1{j}点耐久点数。";
	TRP2_LOC_REA_BAGDAMAGE = "{j}你的包裹失去了{r}%1{j}点耐久点数。";
	
	TRP2_Auras_Categorie[1] = "全部";
	TRP2_Auras_Categorie[2] = "个人";
	TRP2_Auras_Categorie[3] = "任务";
	TRP2_Auras_Categorie[4] = "气味";
	TRP2_Auras_Categorie[5] = "行为";
	TRP2_Auras_Categorie[6] = "心情";
	TRP2_Auras_Categorie[7] = "伤痕/残疾";
	TRP2_Auras_Categorie[8] = "疾病";
	TRP2_Auras_Categorie[9] = "诅咒";
	TRP2_Auras_Categorie[10] = "魔法";
	TRP2_Auras_Categorie[11] = "外形";
	TRP2_Auras_Categorie[12] = "装备";
	TRP2_Auras_Categorie[13] = "动作";
	TRP2_Auras_Categorie[14] = "气质";
	TRP2_Auras_Categorie[15] = "中毒";
	TRP2_Auras_Categorie[16] = "病症";
end

function TRP2_LocalisationBalisesChinese()
	TRP2_BALISETAB[1]["Nom"] = "{00ffff}超大标题 (左)";
	TRP2_BALISETAB[1]["Code"] = "{titre1}超大标题 {/titre1}";
	TRP2_BALISETAB[2]["Nom"] = "{00ffff}超大标题  (中)";
	TRP2_BALISETAB[2]["Code"] = "{titre1:centre}超大标题 {/titre1}";
	TRP2_BALISETAB[3]["Nom"] = "{00ffff}超大标题  (右)";
	TRP2_BALISETAB[3]["Code"] = "{titre1:droite}超大标题 {/titre1}";
	TRP2_BALISETAB[4]["Nom"] = "{00ffcc}大标题 (左)";
	TRP2_BALISETAB[4]["Code"] = "{titre2}大标题{/titre2}";
	TRP2_BALISETAB[5]["Nom"] = "{00ffcc}大标题 (中)";
	TRP2_BALISETAB[5]["Code"] = "{titre2:centre}大标题{/titre2}";
	TRP2_BALISETAB[6]["Nom"] = "{00ffcc}大标题 (右)";
	TRP2_BALISETAB[6]["Code"] = "{titre2:droite}大标题{/titre2}";
	TRP2_BALISETAB[7]["Nom"] = "{00ccff}标题 (左)";
	TRP2_BALISETAB[7]["Code"] = "{titre3}标题{/titre3}";
	TRP2_BALISETAB[8]["Nom"] = "{00ccff}标题 (中)";
	TRP2_BALISETAB[8]["Code"] = "{titre3:centre}标题{/titre3}";
	TRP2_BALISETAB[9]["Nom"] = "{00ccff}标题 (右)";
	TRP2_BALISETAB[9]["Code"] = "{titre3:droite}标题{/titre3}";
	TRP2_BALISETAB[10]["Nom"] = "{v}文字 (中)";
	TRP2_BALISETAB[10]["Code"] = "{centre}居中文字{/centre}";
	TRP2_BALISETAB[11]["Nom"] = "{v}文字 (右)";
	TRP2_BALISETAB[11]["Code"] = "{droite}居右文字{/droite}";
	TRP2_BALISETAB[12]["Nom"] = "{j}链接tag";
	TRP2_BALISETAB[12]["Code"] = "{link:your_url:your_text}";
	TRP2_BALISETABNORMAL[1]["Nom"] = "{j}旋转tag";
	TRP2_BALISETABNORMAL[2]["Nom"] = "{v}坐标tag";
	TRP2_BALISETABNORMAL[3]["Nom"] = "{j}目标tag";
	TRP2_BALISETABNORMAL[4]["Nom"] = "{v}人物tag";
	TRP2_BALISETABNORMAL[5]["Nom"] = "{j}图标tag";
	TRP2_BALISETABNORMAL[6]["Nom"] = "{j}地区tag";
	TRP2_BALISETABNORMAL[7]["Nom"] = "{j}具体地点tag";
	TRP2_BALISETABNORMAL[8]["Nom"] = "{j}随机Tag {888888}(请替换X)";
	TRP2_BALISETABNORMAL[9]["Nom"] = "{j}方言tag {888888}(请替换ID)";
	TRP2_BALISETABNORMAL[9]["Code"] = "{dial:ID}你的文字{/dial}";
	TRP2_BALISETABNORMAL[10]["Nom"] = "{j}随机文字tag {888888}(请替换文字)";
	TRP2_BALISETABNORMAL[10]["Code"] = "{randtext:text1+text2}";
	TRP2_DB_Quests["QUE00001"]["Nom"] = "任务";
	TRP2_DB_Quests["QUE00001"]["Description"] = "空白的示例任务，没有数据。";
	TRP2_DB_Objects["ITE00001"]["Nom"] = "物品";
	TRP2_DB_Objects["ITE00001"]["Description"] = "空白的示例物品，没有数据。";
	TRP2_DB_Documents["DOC00001"]["Nom"] = "文件";
	TRP2_DB_Auras["AUR00001"]["Description"] = "空白的示例状态，没有数据。";
	TRP2_DB_Auras["AUR00001"]["Nom"] = "状态";
end

function TRP2_LocalisationCreationChinese()
	TRP2_LISTE_VALEURS["guildnamec"]["Titre"] = "人物：公会名称 (目标)";
	TRP2_LISTE_VALEURS["guildnamec"]["Explication"] = "目标的公会名称";
	TRP2_LISTE_VALEURS["guildnamec"]["ExpliDetails"] = "目标的目标的公会名称。";
	TRP2_LISTE_VALEURS["guildname"]["Titre"] = "人物：公会名称";
	TRP2_LISTE_VALEURS["guildname"]["Explication"] = "公会名称 ";
	TRP2_LISTE_VALEURS["guildname"]["ExpliDetails"] = "人物的公会名称。";
	TRP2_LISTE_VALEURS["queststep"]["Titre"] = "任务：当前步骤";
	TRP2_LISTE_VALEURS["queststep"]["Explication"] = "任务当前正在进行的步骤";
	TRP2_LISTE_VALEURS["queststep"]["ExpliDetails"] = "任务当前的ID。0表示任务不在任务列表中。";
	TRP2_LISTE_VALEURS["queststep"]["Argument"] = "已选任务";
	TRP2_LISTE_VALEURS["masconame"]["Titre"] = "小伙伴：小伙伴的名称";
	TRP2_LISTE_VALEURS["masconame"]["Explication"] = "小伙伴的名称 ";
	TRP2_LISTE_VALEURS["masconame"]["ExpliDetails"] = "当前已召唤的小伙伴的名称。";
	TRP2_LISTE_VALEURS["petname"]["Titre"] = "宠物：宠物的名称";
	TRP2_LISTE_VALEURS["petname"]["Explication"] = "宠物的名称 ";
	TRP2_LISTE_VALEURS["petname"]["ExpliDetails"] = "当前已召唤的宠物的名称。";
	TRP2_LISTE_VALEURS["mountname"]["Titre"] = "坐骑：坐骑的名称";
	TRP2_LISTE_VALEURS["mountname"]["Explication"] = "坐骑的名称 ";
	TRP2_LISTE_VALEURS["mountname"]["ExpliDetails"] = "目前已召唤的坐骑的名称。";
	TRP2_LISTE_VALEURS["dist28yard"]["Titre"] = "人物：目标距离 (查看)";
	TRP2_LISTE_VALEURS["dist28yard"]["Explication"] = "人物位于目标的查看距离内";
	TRP2_LISTE_VALEURS["dist28yard"]["ExpliDetails"] = "评测人物是否位于目标的查看距离之内 (~25.6码)。1表示 已位于。";
	TRP2_LISTE_VALEURS["dist10yard"]["Titre"] = "人物：目标距离 (战斗)";
	TRP2_LISTE_VALEURS["dist10yard"]["Explication"] = "人物位于目标的战斗距离内";
	TRP2_LISTE_VALEURS["dist10yard"]["ExpliDetails"] = "评测人物是否位于目标的战斗距离之内 (~9码)。1表示 已位于。";
	TRP2_LISTE_VALEURS["coffre"]["Titre"] = "箱子：当前耐久度";
	TRP2_LISTE_VALEURS["coffre"]["Explication"] = "箱子当前的耐久度";
	TRP2_LISTE_VALEURS["coffre"]["ExpliDetails"] = "箱子当前的耐久度。";
	TRP2_LISTE_VALEURS["coffremax"]["Titre"] = "箱子：耐久度上限";
	TRP2_LISTE_VALEURS["coffremax"]["Explication"] = "箱子的耐久度上限";
	TRP2_LISTE_VALEURS["coffremax"]["ExpliDetails"] = "箱子的最大耐久度。";
	TRP2_LISTE_VALEURS["sacados"]["Titre"] = "背包：当前耐久度";
	TRP2_LISTE_VALEURS["sacados"]["Explication"] = "背包当前的耐久度";
	TRP2_LISTE_VALEURS["sacados"]["ExpliDetails"] = "背包当前的耐久度。";
	TRP2_LISTE_VALEURS["sacadosmax"]["Titre"] = "背包：耐久度上限";
	TRP2_LISTE_VALEURS["sacadosmax"]["Explication"] = "背包的耐久度上限";
	TRP2_LISTE_VALEURS["sacadosmax"]["ExpliDetails"] = "背包的最大耐久度。";
	TRP2_LISTE_VALEURS["cible"]["Titre"] = "人物：拥有目标";
	TRP2_LISTE_VALEURS["cible"]["Explication"] = "人物当前拥有目标";
	TRP2_LISTE_VALEURS["cible"]["ExpliDetails"] = "评测人物是否拥有目标。1表示有。";
	TRP2_LISTE_VALEURS["isdead"]["Titre"] = "人物：死亡";
	TRP2_LISTE_VALEURS["isdead"]["Explication"] = "人物已死亡";
	TRP2_LISTE_VALEURS["isdead"]["ExpliDetails"] = "评测人物是否死亡 (不管有没有释放灵魂)。1表示已死亡。";
	TRP2_LISTE_VALEURS["ismount"]["Titre"] = "人物：坐骑";
	TRP2_LISTE_VALEURS["ismount"]["Explication"] = "人物在使用坐骑";
	TRP2_LISTE_VALEURS["ismount"]["ExpliDetails"] = "评测人物是否在使用坐骑，但不在飞行 (可以骑在飞行坐骑上，但必须位于地面)。1表示有坐骑。";
	TRP2_LISTE_VALEURS["isflying"]["Titre"] = "人物：飞行";
	TRP2_LISTE_VALEURS["isflying"]["Explication"] = "人物正在飞行";
	TRP2_LISTE_VALEURS["isflying"]["ExpliDetails"] = "评测人物是否正在飞行 (使用飞行坐骑或飞行形态)。1表示在飞行。";
	TRP2_LISTE_VALEURS["istaxi"]["Titre"] = "人物：自动飞行";
	TRP2_LISTE_VALEURS["istaxi"]["Explication"] = "人物在使用自动飞行";
	TRP2_LISTE_VALEURS["istaxi"]["ExpliDetails"] = "评测人物是否在使用自动飞行。 1表示在。";
	TRP2_LISTE_VALEURS["isfalling"]["Titre"] = "人物：坠落";
	TRP2_LISTE_VALEURS["isfalling"]["Explication"] = "人物正在坠落";
	TRP2_LISTE_VALEURS["isfalling"]["ExpliDetails"] = "评测人物是否正在坠落。1表示在。";
	TRP2_LISTE_VALEURS["isstealthed"]["Titre"] = "人物：潜行";
	TRP2_LISTE_VALEURS["isstealthed"]["Explication"] = "人物处于潜行状态";
	TRP2_LISTE_VALEURS["isstealthed"]["ExpliDetails"] = "评测人物是否处于潜行状态 (潜行者，喵化版德鲁伊，etc.)。1表示是。";
	TRP2_LISTE_VALEURS["isswimming"]["Titre"] = "人物：游泳";
	TRP2_LISTE_VALEURS["isswimming"]["Explication"] = "人物正在游泳";
	TRP2_LISTE_VALEURS["isswimming"]["ExpliDetails"] = "评测人物是否正在游泳。1表示在。";
	TRP2_LISTE_VALEURS["isflyablearea"]["Titre"] = "人物：可飞行";
	TRP2_LISTE_VALEURS["isflyablearea"]["Explication"] = "人物可以飞行";
	TRP2_LISTE_VALEURS["isflyablearea"]["ExpliDetails"] = "评测人物是否位于可飞行地区。1表示在。";
	TRP2_LISTE_VALEURS["ispet"]["Titre"] = "人物：宠物";
	TRP2_LISTE_VALEURS["ispet"]["Explication"] = "人物已召唤宠物";
	TRP2_LISTE_VALEURS["ispet"]["ExpliDetails"] = "评测人物是否召唤了宠物。1表示有。";
	TRP2_LISTE_VALEURS["isminion"]["Titre"] = "人物：小伙伴";
	TRP2_LISTE_VALEURS["isminion"]["Explication"] = "人物已召唤小伙伴";
	TRP2_LISTE_VALEURS["isminion"]["ExpliDetails"] = "评测人物是否召唤了小伙伴。1表示有。";
	TRP2_LISTE_VALEURS["isdeadc"]["Titre"] = "人物：死亡 (目标)";
	TRP2_LISTE_VALEURS["isdeadc"]["Explication"] = "人物的目标已死亡";
	TRP2_LISTE_VALEURS["isdeadc"]["ExpliDetails"] = "评测人物的目标是否死亡 (不管有没有释放灵魂)。1表示已死亡。";
	TRP2_LISTE_VALEURS["typec"]["Titre"] = "人物：种类 (目标)";
	TRP2_LISTE_VALEURS["typec"]["Explication"] = "人物目标的种类";
	TRP2_LISTE_VALEURS["typec"]["ExpliDetails"] = "决定目标属于哪个种类。有效的值为：野兽，龙类，恶魔，元素生物，巨人，亡灵，人型生物，小动物，机械，未指定，图腾，宠物。";
	TRP2_LISTE_VALEURS["familyc"]["Titre"] = "人物：级别 (目标)";
	TRP2_LISTE_VALEURS["familyc"]["Explication"] = "人物目标的级别";
	TRP2_LISTE_VALEURS["familyc"]["ExpliDetails"] = "决定目标属于哪个级别。有效值为：普通，精英，稀有精英，首领，稀有。";
	TRP2_LISTE_VALEURS["sex"]["Titre"] = "人物：性别";
	TRP2_LISTE_VALEURS["sex"]["Explication"] = "人物的性别";
	TRP2_LISTE_VALEURS["sex"]["ExpliDetails"] = "评测人物的性别。有效的值为：1 (未知)，2 (男性)，3 (女性)。";
	TRP2_LISTE_VALEURS["sexc"]["Titre"] = "人物：性别 (目标)";
	TRP2_LISTE_VALEURS["sexc"]["Explication"] = "人物目标的性别";
	TRP2_LISTE_VALEURS["sexc"]["ExpliDetails"] = "评测人物目标的性别。有效的值为：1 (未知)，2 (男性)，3 (女性)。";
	TRP2_LISTE_VALEURS["name"]["Titre"] = "人物：名称";
	TRP2_LISTE_VALEURS["name"]["Explication"] = "人物的名称";
	TRP2_LISTE_VALEURS["name"]["ExpliDetails"] = "人物的名称。";
	TRP2_LISTE_VALEURS["namec"]["Titre"] = "人物：名称 (目标)";
	TRP2_LISTE_VALEURS["namec"]["Explication"] = "人物目标的名称";
	TRP2_LISTE_VALEURS["namec"]["ExpliDetails"] = "人物目标的名称。";
	TRP2_LISTE_VALEURS["nametrpc"]["Titre"] = "人物：TRP2名称 (目标)";
	TRP2_LISTE_VALEURS["nametrpc"]["Explication"] = "人物目标的TRP2名称";
	TRP2_LISTE_VALEURS["nametrpc"]["ExpliDetails"] = "人物目标的TRP2自定义名称。";
	TRP2_LISTE_VALEURS["class"]["Titre"] = "人物：职业";
	TRP2_LISTE_VALEURS["class"]["Explication"] = "人物的职业";
	TRP2_LISTE_VALEURS["class"]["ExpliDetails"] = "这是人物的职业。比如说，\"法师\", \"战士\", \"死亡骑士\", etc。";
	TRP2_LISTE_VALEURS["classc"]["Titre"] = "人物：职业 (目标)";
	TRP2_LISTE_VALEURS["classc"]["Explication"] = "人物目标的职业";
	TRP2_LISTE_VALEURS["classc"]["ExpliDetails"] = "这是人物目标的职业。比如说，\"法师\", \"战士\", \"死亡骑士\", etc。";
	TRP2_LISTE_VALEURS["race"]["Titre"] = "人物：种族";
	TRP2_LISTE_VALEURS["race"]["Explication"] = "人物的种族";
	TRP2_LISTE_VALEURS["race"]["ExpliDetails"] = "这是人物的种族。";
	TRP2_LISTE_VALEURS["racec"]["Titre"] = "人物：种族 (目标)";
	TRP2_LISTE_VALEURS["racec"]["Explication"] = "人物目标的种族";
	TRP2_LISTE_VALEURS["racec"]["ExpliDetails"] = "这是人物目标的种族。";
	TRP2_LISTE_VALEURS["coord"]["Titre"] = "人物：地图：完整坐标";
	TRP2_LISTE_VALEURS["coord"]["Explication"] = "人物的坐标";
	TRP2_LISTE_VALEURS["coord"]["ExpliDetails"] = "人物的完整坐标。语序为：\nzone_number x y\n警告：世界地图显示时，坐标为0! (详情请见使用手册)";
	TRP2_LISTE_VALEURS["souszone"]["Titre"] = "人物：地图：具体地点";
	TRP2_LISTE_VALEURS["souszone"]["Explication"] = "人物的具体地点";
	TRP2_LISTE_VALEURS["souszone"]["ExpliDetails"] = "这是人物所在的具体地点的名称，也就是小地图上方显示的名称。在副本中也有效。";
	TRP2_LISTE_VALEURS["zone"]["Titre"] = "人物：地图：地区";
	TRP2_LISTE_VALEURS["zone"]["Explication"] = "人物的所在地区";
	TRP2_LISTE_VALEURS["zone"]["ExpliDetails"] = "这是人物所在的地区名称。一般来说，它会显示在你的大地图上。";
	TRP2_LISTE_VALEURS["objplace"]["Titre"] = "背包：空位";
	TRP2_LISTE_VALEURS["objplace"]["Explication"] = "背包中空位的数量";
	TRP2_LISTE_VALEURS["objplace"]["ExpliDetails"] = "评测背包中空位的数量。";
	TRP2_LISTE_VALEURS["langnum"]["Titre"] = "方言：方言数量";
	TRP2_LISTE_VALEURS["langnum"]["Explication"] = "人物会说的方言数量";
	TRP2_LISTE_VALEURS["langnum"]["ExpliDetails"] = "评测人物会说的方言的总数。";
	TRP2_LISTE_VALEURS["langmaitrise"]["Titre"] = "方言：流利度";
	TRP2_LISTE_VALEURS["langmaitrise"]["Explication"] = "方言的流利度";
	TRP2_LISTE_VALEURS["langmaitrise"]["ExpliDetails"] = "指定方言的流利度 (0-100)。-1表示人物完全不会这个方言。";
	TRP2_LISTE_VALEURS["langmaitrise"]["Argument"] = "已选方言";
	TRP2_LISTE_VALEURS["coolnum"]["Titre"] = "物品：冷却";
	TRP2_LISTE_VALEURS["coolnum"]["Explication"] = "物品的冷却时间";
	TRP2_LISTE_VALEURS["coolnum"]["ExpliDetails"] = "指定物品的冷却时间。0表示不需要冷却时间。";
	TRP2_LISTE_VALEURS["coolnum"]["Argument"] = "已选物品";
	TRP2_LISTE_VALEURS["rotation"]["Titre"] = "人物：方向";
	TRP2_LISTE_VALEURS["rotation"]["Explication"] = "人物的方向 (弧度)";
	TRP2_LISTE_VALEURS["rotation"]["ExpliDetails"] = "人物面向的方向 (以弧度为单位)。0 = 正北，并以逆时针方向增加。\n比如说：180° = 正南 = π = 3,14。 ;-)";
	TRP2_LISTE_VALEURS["rand"]["Titre"] = "数字：Roll 100";
	TRP2_LISTE_VALEURS["rand"]["Explication"] = "1与100之间的随机数字";
	TRP2_LISTE_VALEURS["rand"]["ExpliDetails"] = "在 1 与 100 之间随机Roll一个数字。";
	TRP2_LISTE_VALEURS["randmille"]["Titre"] = "数字：Roll 1000";
	TRP2_LISTE_VALEURS["randmille"]["Explication"] = "1与1000之间的随机数字";
	TRP2_LISTE_VALEURS["randmille"]["ExpliDetails"] = "在 1 与 1000 之间随机Roll一个数字。";
	TRP2_LISTE_VALEURS["randdixmille"]["Titre"] = "数字：Roll 10000";
	TRP2_LISTE_VALEURS["randdixmille"]["Explication"] = "1与10000之间的随机数字";
	TRP2_LISTE_VALEURS["randdixmille"]["ExpliDetails"] = "在 1 与 10000 之间随机Roll一个数字。";
	TRP2_LISTE_VALEURS["pv"]["Titre"] = "人物：HP";
	TRP2_LISTE_VALEURS["pv"]["Explication"] = "人物当前的HP";
	TRP2_LISTE_VALEURS["pv"]["ExpliDetails"] = "人物当前HP的数值。";
	TRP2_LISTE_VALEURS["pvc"]["Titre"] = "人物：目标HP";
	TRP2_LISTE_VALEURS["pvc"]["Explication"] = "目标当前的HP";
	TRP2_LISTE_VALEURS["pvc"]["ExpliDetails"] = "目标当前HP的数值。";
	TRP2_LISTE_VALEURS["objcnt"]["Titre"] = "物品：物品数量 (背包+箱子)";
	TRP2_LISTE_VALEURS["objcnt"]["Explication"] = "背包与箱子中的物品数量";
	TRP2_LISTE_VALEURS["objcnt"]["ExpliDetails"] = "评测指定物品在背包与箱子中的总单位量。";
	TRP2_LISTE_VALEURS["objcnt"]["Argument"] = "已选物品";
	TRP2_LISTE_VALEURS["auranum"]["Titre"] = "状态：状态数量 (人物)";
	TRP2_LISTE_VALEURS["auranum"]["Explication"] = "人物当前的状态数量";
	TRP2_LISTE_VALEURS["auranum"]["ExpliDetails"] = "人物身上当前的状态数量";
	TRP2_LISTE_VALEURS["auranummount"]["Titre"] = "状态：状态数量 (坐骑)";
	TRP2_LISTE_VALEURS["auranummount"]["Explication"] = "坐骑当前的状态数量";
	TRP2_LISTE_VALEURS["auranummount"]["ExpliDetails"] = "坐骑身上当前的状态数量";
	TRP2_LISTE_VALEURS["auranumpet"]["Titre"] = "状态：状态数量 (宠物)";
	TRP2_LISTE_VALEURS["auranumpet"]["Explication"] = "宠物当前的状态数量";
	TRP2_LISTE_VALEURS["auranumpet"]["ExpliDetails"] = "宠物身上当前的状态数量";
	TRP2_LISTE_VALEURS["auranumminion"]["Titre"] = "状态：状态数量 (小伙伴)";
	TRP2_LISTE_VALEURS["auranumminion"]["Explication"] = "小伙伴当前的状态数量";
	TRP2_LISTE_VALEURS["auranumminion"]["ExpliDetails"] = "小伙伴身上当前的状态数量";
	TRP2_LISTE_VALEURS["aurat"]["Titre"] = "状态：剩余时间 (人物)";
	TRP2_LISTE_VALEURS["aurat"]["Explication"] = "人物状态的剩余时间(秒)";
	TRP2_LISTE_VALEURS["aurat"]["ExpliDetails"] = "人物状态的剩余时间(秒)。{j}-1表示没有状态";
	TRP2_LISTE_VALEURS["aurat"]["Argument"] = "已选状态";
	TRP2_LISTE_VALEURS["auratmount"]["Titre"] = "状态：坐骑";
	TRP2_LISTE_VALEURS["auratmount"]["Explication"] = "当前的坐骑带有指定的状态";
	TRP2_LISTE_VALEURS["auratmount"]["ExpliDetails"] = "决定当前的坐骑是否带有指定的状态。{j}-1表示没有状态，或者没有在使用坐骑。";
	TRP2_LISTE_VALEURS["auratmount"]["Argument"] = "已选状态";
	TRP2_LISTE_VALEURS["auratpet"]["Titre"] = "状态：宠物";
	TRP2_LISTE_VALEURS["auratpet"]["Explication"] = "当前的宠物带有指定的状态";
	TRP2_LISTE_VALEURS["auratpet"]["ExpliDetails"] = "决定当前的宠物是否带有指定的状态。{j}-1表示没有状态，或者没有召唤出宠物。";
	TRP2_LISTE_VALEURS["auratpet"]["Argument"] = "已选状态";
	TRP2_LISTE_VALEURS["auratminion"]["Titre"] = "状态：小伙伴";
	TRP2_LISTE_VALEURS["auratminion"]["Explication"] = "当前的小伙伴带有指定的状态";
	TRP2_LISTE_VALEURS["auratminion"]["ExpliDetails"] = "决定当前的小伙伴是否带有指定的状态。{j}-1表示没有状态，或者没有召唤出小伙伴。";
	TRP2_LISTE_VALEURS["auratminion"]["Argument"] = "已选状态";
	TRP2_LISTE_VALEURS["aurattarget"]["Titre"] = "状态：目标";
	TRP2_LISTE_VALEURS["aurattarget"]["Explication"] = "目标带有指定的状态";
	TRP2_LISTE_VALEURS["aurattarget"]["ExpliDetails"] = "决定当前的目标 (玩家) 是否带有指定的状态。{j}-1表示没有状态，或者没有目标。";
	TRP2_LISTE_VALEURS["aurattarget"]["Argument"] = "已选状态";
	TRP2_LISTE_VALEURS["speed"]["Titre"] = "人物：速度";
	TRP2_LISTE_VALEURS["speed"]["Explication"] = "人物的移动速度";
	TRP2_LISTE_VALEURS["speed"]["ExpliDetails"] = "评测人物当前的移动速度\n提示:\n正常情况下的100%速度 = 7.";
	TRP2_LISTE_VALEURS["persotaille"]["Titre"] = "人物：身高";
	TRP2_LISTE_VALEURS["persotaille"]["Explication"] = "人物的身高";
	TRP2_LISTE_VALEURS["persotaille"]["ExpliDetails"] = "人物的身高。有效值为1-5：\n{j}1 = 极矮\n{j}2 = 矮小\n{j}3 = 中等\n{j}4 = 高挑\n{j}5 = 极高\n";
	TRP2_LISTE_VALEURS["persosil"]["Titre"] = "人物：体型";
	TRP2_LISTE_VALEURS["persosil"]["Explication"] = "人物的体型";
	TRP2_LISTE_VALEURS["persosil"]["ExpliDetails"] = "人物的体型。有效值为1-4：:\n{j}1 = 超重\n{j}2 = 普通\n{j}3 = 健壮\n{j}4 = 消瘦";
	TRP2_LISTE_VALEURS["persotaillec"]["Titre"] = "人物：身高 (目标)";
	TRP2_LISTE_VALEURS["persotaillec"]["Explication"] = "目标的身高";
	TRP2_LISTE_VALEURS["persotaillec"]["ExpliDetails"] = "目标的身高。有效值为1-5：\n{j}1 = 极矮\n{j}2 = 矮小\n{j}3 = 中等\n{j}4 = 高挑\n{j}5 = 极高\n";
	TRP2_LISTE_VALEURS["persosilc"]["Titre"] = "人物：体型 (目标)";
	TRP2_LISTE_VALEURS["persosilc"]["Explication"] = "目标的体型";
	TRP2_LISTE_VALEURS["persosilc"]["ExpliDetails"] = "目标的体型。有效值为1-4：:\n{j}1 = 超重\n{j}2 = 普通\n{j}3 = 健壮\n{j}4 = 消瘦";
	TRP2_LISTE_COMPA["=="]["Titre"] = "等于";
	TRP2_LISTE_COMPA["=="]["Explication"] = "{w}检查第1个值是否等于第2个。\n{v}可以用于数值和文字。";
	TRP2_LISTE_COMPA["~="]["Titre"] = "不等于";
	TRP2_LISTE_COMPA["~="]["Explication"] = "{w}检查第1个值是否与第2个不同。\n{v}可以用于数值和文字。";
	TRP2_LISTE_COMPA[">"]["Titre"] = "大于";
	TRP2_LISTE_COMPA[">"]["Explication"] = "{w}检查第1个值是否大于第2个。\n{v}仅可用于数值。";
	TRP2_LISTE_COMPA["<"]["Titre"] = "小于";
	TRP2_LISTE_COMPA["<"]["Explication"] = "{w}检查第1个值是否小于第2个。\n{v}仅可用于数值。";
	TRP2_LISTE_COMPA[">="]["Titre"] = "大于或等于";
	TRP2_LISTE_COMPA[">="]["Explication"] = "{w}检查第1个值是否大于或等于第2个。\n{v}仅可用于数值。";
	TRP2_LISTE_COMPA["<="]["Titre"] = "小于或等于";
	TRP2_LISTE_COMPA["<="]["Explication"] = "{w}检查第1个值是否小于或等于第2个。\n{v}仅可用于数值。";
	TRP2_LISTE_EFFETS["mascotte"]["Titre"] = "召唤小伙伴/坐骑";
	TRP2_LISTE_EFFETS["mascotte"]["Explication"] = "召唤出指定的小伙伴/坐骑。";
	TRP2_LISTE_EFFETS["lang"]["Titre"] = "方言流利度";
	TRP2_LISTE_EFFETS["lang"]["Explication"] = "设定指定方言的流利度";
	TRP2_LISTE_EFFETS["docu"]["Titre"] = "显示文件";
	TRP2_LISTE_EFFETS["docu"]["Explication"] = "显示指定文件。";
	TRP2_LISTE_EFFETS["durabilite"]["Titre"] = "改变耐久度";
	TRP2_LISTE_EFFETS["durabilite"]["Explication"] = "增加或减少背包或箱子的耐久度。";
	TRP2_LISTE_EFFETS["texte"]["Titre"] = "显示文字";
	TRP2_LISTE_EFFETS["texte"]["Explication"] = "显示一段文字。这会是私人文字，只能被玩家自己看到。";
	TRP2_LISTE_EFFETS["discotte"]["Titre"] = "解散小伙伴";
	TRP2_LISTE_EFFETS["discotte"]["Explication"] = "解散当前的小伙伴";
	TRP2_LISTE_EFFETS["dismount"]["Titre"] = "解散坐骑";
	TRP2_LISTE_EFFETS["dismount"]["Explication"] = "强行解散当前的坐骑。\n警告: 这在飞行中也有效!!!";
	TRP2_LISTE_EFFETS["critter"]["Titre"] = "召唤小伙伴";
	TRP2_LISTE_EFFETS["critter"]["Explication"] = "随机召唤出小伙伴。";
	TRP2_LISTE_EFFETS["sheath"]["Titre"] = "取出/收起武器";
	TRP2_LISTE_EFFETS["sheath"]["Explication"] = "人物将根据情况，取出或收起武器。";
	TRP2_LISTE_EFFETS["parole"]["Titre"] = "说话/表情";
	TRP2_LISTE_EFFETS["parole"]["Explication"] = "人物会说一句话，或者做个表情。你可以指定频道 (说，公会，etc.）。";
	TRP2_LISTE_EFFETS["or"]["Titre"] = "添加/移除金钱";
	TRP2_LISTE_EFFETS["or"]["Explication"] = "在背包中添加或移除指定数量的金钱";
	TRP2_LISTE_EFFETS["aura"]["Titre"] = "添加/移除状态";
	TRP2_LISTE_EFFETS["aura"]["Explication"] = "在指定时间中 (0 = 无限)，添加(或移除)一个状态 (如果还有位置的话)。";
	TRP2_LISTE_EFFETS["son"]["Titre"] = "播放音效";
	TRP2_LISTE_EFFETS["son"]["Explication"] = "播放指定音效。玩家和周围的人会听到该音效。";
	TRP2_LISTE_EFFETS["objet"]["Titre"] = "物品栏：添加/移除";
	TRP2_LISTE_EFFETS["objet"]["Explication"] = "在物品栏中添加或移除一定数量的指定物品。";
	TRP2_LISTE_EFFETS["cool"]["Titre"] = "物品栏：冷却";
	TRP2_LISTE_EFFETS["cool"]["Explication"] = "在一定时间内，触发指定物品种类的冷却。";
	TRP2_LISTE_EFFETS["lifetime"]["Titre"] = "物品栏：寿命";
	TRP2_LISTE_EFFETS["lifetime"]["Explication"] = "触发正在使用的物品的寿命。\n{r}只能在以下事件中使用：\n"
						.."{o}- 使用时(start或end)\n- 使用失败时(start或end)";
	TRP2_LISTE_EFFETS["quest"]["Titre"] = "任务：变更步骤";
	TRP2_LISTE_EFFETS["quest"]["Explication"] = "变更任务当前的步骤。";
end

function TRP2_LocalisationBagsChinese()
	TRP2_SacsADos["1"]["Nom"] = "普通游荡者背包";
	TRP2_SacsADos["1"]["Description"] = "带着皮带的小布包。不是特别的耐用，但是很轻便。";
	TRP2_CoffreMonture["1"]["Nom"] = "小木箱";
	TRP2_CoffreMonture["1"]["Description"] = "带有铁件的小木箱。很适合坐骑运输。";
end

function TRP2_LocalisationLanguagesChinese()
	TRP2_DB_Languages["LAN00001"]["Entete"] = "龙语";
	TRP2_DB_Languages["LAN00001"]["Nom"] = "龙语";
	TRP2_DB_Languages["LAN00001"]["Description"] = "龙族的方言。";
	TRP2_DB_Languages["LAN00002"]["Entete"] = "鸦人语";
	TRP2_DB_Languages["LAN00002"]["Nom"] = "鸦人语";
	TRP2_DB_Languages["LAN00002"]["Description"] = "鸦人的方言。 仅为口头语言。";
	TRP2_DB_Languages["LAN00003"]["Entete"] = "艾瑞达语";
	TRP2_DB_Languages["LAN00003"]["Nom"] = "艾瑞达语";
	TRP2_DB_Languages["LAN00003"]["Description"] = "恶魔的方言。";
	TRP2_DB_Languages["LAN00004"]["Entete"] = "卡利麦格语 ";
	TRP2_DB_Languages["LAN00004"]["Nom"] = "卡利麦格语 ";
	TRP2_DB_Languages["LAN00004"]["Description"] = "元素生物的方言。";
	TRP2_DB_Languages["LAN00005"]["Entete"] = "鱼人语";
	TRP2_DB_Languages["LAN00005"]["Nom"] = "鱼人语";
	TRP2_DB_Languages["LAN00005"]["Description"] = "鱼人的方言。仅为口头语言。";
	TRP2_DB_Languages["LAN00006"]["Entete"] = "二进制";
	TRP2_DB_Languages["LAN00006"]["Nom"] = "二进制";
	TRP2_DB_Languages["LAN00006"]["Description"] = "机器的方言。仅为书面语言。";
	TRP2_DB_Languages["LAN00007"]["Entete"] = "黑铁语";
	TRP2_DB_Languages["LAN00007"]["Nom"] = "黑铁语";
	TRP2_DB_Languages["LAN00007"]["Description"] = "黑铁部族的方言。";
	TRP2_DB_Languages["LAN00008"]["Entete"] = "德鲁伊语";
	TRP2_DB_Languages["LAN00008"]["Nom"] = "德鲁伊语";
	TRP2_DB_Languages["LAN00008"]["Description"] = "德鲁伊的方言。";
	TRP2_DB_Languages["LAN00009"]["Entete"] = "尼拉布语";
	TRP2_DB_Languages["LAN00009"]["Nom"] = "尼拉布语";
	TRP2_DB_Languages["LAN00009"]["Description"] = "蛛魔的方言。 仅为口头语言。";
	TRP2_DB_Languages["Troll"]["Description"] = "巨魔的方言。";
	TRP2_DB_Languages["Taurahe"]["Description"] = "牛头人的方言。";
	TRP2_DB_Languages["Goblin"]["Description"] = "地精的方言。";
	TRP2_DB_Languages["Pandaren"]["Description"] = "熊猫人的方言";
end