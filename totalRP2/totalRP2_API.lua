...
-- Added by Ellypse for 5.4.7
-- Return only the name if the Name-Realm is the player
...
-- Removed since version 1.028. MRP author said he will fix his issue and we
-- agreed with other authors to send color tags via MSP. 
