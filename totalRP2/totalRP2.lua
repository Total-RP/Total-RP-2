...
function TRP2_OnLoaded()
	...
	if (select(4, GetBuildInfo())) < 60100 then
		StaticPopupDialogs["TRP2_JUST_TEXT"].text = TRP2_CTS(TRP2_ENTETE.."|cffff0000THIS VERSION REQUIRES PATCH 6.1 AND WON'T WORK CORRECTLY ON YOUR VERSION OF WORLD OF WARCRAFT|r");
		TRP2_ShowStaticPopup("TRP2_JUST_TEXT");
	end
	-- MSP support
